...
namespace CefGlue
{
    ...
    public abstract unsafe partial class CefDomVisitor
    {
        ...
        private cef_domvisitor_t.has_at_least_one_ref_delegate _ds3;
        private cef_domvisitor_t.visit_delegate _ds4;
        ...
        protected CefDomVisitor()
        {
            ...
            _ds3 = new cef_domvisitor_t.has_at_least_one_ref_delegate(has_at_least_one_ref);
            _self->_base._has_at_least_one_ref = Marshal.GetFunctionPointerForDelegate(_ds3);
            _ds4 = new cef_domvisitor_t.visit_delegate(visit);
        ...
        private int has_at_least_one_ref(cef_domvisitor_t* self)
        {
