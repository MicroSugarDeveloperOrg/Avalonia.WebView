...
namespace CefGlue
{
    ...
    public abstract unsafe partial class CefDialogHandler
    {
        ...
        private cef_dialog_handler_t.has_at_least_one_ref_delegate _ds3;
        private cef_dialog_handler_t.on_file_dialog_delegate _ds4;
        ...
        protected CefDialogHandler()
        {
            ...
            _ds3 = new cef_dialog_handler_t.has_at_least_one_ref_delegate(has_at_least_one_ref);
            _self->_base._has_at_least_one_ref = Marshal.GetFunctionPointerForDelegate(_ds3);
            _ds4 = new cef_dialog_handler_t.on_file_dialog_delegate(on_file_dialog);
            _self->_on_file_dialog = Marshal.GetFunctionPointerForDelegate(_ds4);
        }
        ...
        private int has_at_least_one_ref(cef_dialog_handler_t* self)
        {
