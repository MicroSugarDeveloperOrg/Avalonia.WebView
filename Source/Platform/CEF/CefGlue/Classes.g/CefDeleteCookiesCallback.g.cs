...
namespace CefGlue
{
    ...
    public abstract unsafe partial class CefDeleteCookiesCallback
    {
        ...
        private cef_delete_cookies_callback_t.has_at_least_one_ref_delegate _ds3;
        private cef_delete_cookies_callback_t.on_complete_delegate _ds4;
        ...
        protected CefDeleteCookiesCallback()
        {
            ...
            _ds3 = new cef_delete_cookies_callback_t.has_at_least_one_ref_delegate(has_at_least_one_ref);
            _self->_base._has_at_least_one_ref = Marshal.GetFunctionPointerForDelegate(_ds3);
            _ds4 = new cef_delete_cookies_callback_t.on_complete_delegate(on_complete);
            _self->_on_complete = Marshal.GetFunctionPointerForDelegate(_ds4);
        }
