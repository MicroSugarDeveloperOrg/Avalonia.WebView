...
namespace CefGlue
{
    ...
    public abstract unsafe partial class CefKeyboardHandler
    {
        ...
        private cef_keyboard_handler_t.has_at_least_one_ref_delegate _ds3;
        private cef_keyboard_handler_t.on_pre_key_event_delegate _ds4;
        private cef_keyboard_handler_t.on_key_event_delegate _ds5;
        ...
        protected CefKeyboardHandler()
        {
            ...
            _ds3 = new cef_keyboard_handler_t.has_at_least_one_ref_delegate(has_at_least_one_ref);
            _self->_base._has_at_least_one_ref = Marshal.GetFunctionPointerForDelegate(_ds3);
            _ds4 = new cef_keyboard_handler_t.on_pre_key_event_delegate(on_pre_key_event);
            _self->_on_pre_key_event = Marshal.GetFunctionPointerForDelegate(_ds4);
            _ds5 = new cef_keyboard_handler_t.on_key_event_delegate(on_key_event);
            _self->_on_key_event = Marshal.GetFunctionPointerForDelegate(_ds5);
        }
