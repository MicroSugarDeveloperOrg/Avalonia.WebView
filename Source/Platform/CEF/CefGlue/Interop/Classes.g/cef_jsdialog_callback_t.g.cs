...
namespace CefGlue.Interop
{
    ...
    internal unsafe struct cef_jsdialog_callback_t
    {
        ...
        #endif
        private delegate void add_ref_delegate(cef_jsdialog_callback_t* self);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate int release_delegate(cef_jsdialog_callback_t* self);
        
        [UnmanagedFunctionPointer(libcef.CEF_CALLBACK)]
        #if !DEBUG
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate int has_one_ref_delegate(cef_jsdialog_callback_t* self);
