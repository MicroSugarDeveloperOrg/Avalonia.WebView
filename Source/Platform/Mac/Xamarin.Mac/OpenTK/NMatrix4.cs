...
public struct NMatrix4 : IEquatable<NMatrix4>
{
	...
	public static readonly NMatrix4 Identity = new NMatrix4
	{
		M11 = 1f,
		M22 = 1f,
		M33 = 1f,
	...
	public NMatrix4(Vector4 row0, Vector4 row1, Vector4 row2, Vector4 row3)
	{
		M11 = row0.X;
		M21 = row1.X;
		M31 = row2.X;
	...
	public static explicit operator Matrix4(NMatrix4 value)
	{
		return new Matrix4(value.M11, value.M12, value.M13, value.M14, value.M21, value.M22, value.M23, value.M24, value.M31, value.M32, value.M33, value.M34, value.M41, value.M42, value.M43, value.M44);
	}

	public static explicit operator NMatrix4(Matrix4 value)
	{
