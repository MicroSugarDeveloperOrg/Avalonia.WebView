...
[Protocol]
[Register("NSCollectionViewDelegateFlowLayout", false)]
[Model]
[Introduced(PlatformName.MacOSX, 10, 11, PlatformArchitecture.All, null)]
public class NSCollectionViewDelegateFlowLayout : NSObject, INSCollectionViewDelegateFlowLayout, INativeObject, IDisposable, INSCollectionViewDelegate
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected NSCollectionViewDelegateFlowLayout(NSObjectFlag t)
		: base(t)
	{
		base.IsDirectBinding = false;
	}
