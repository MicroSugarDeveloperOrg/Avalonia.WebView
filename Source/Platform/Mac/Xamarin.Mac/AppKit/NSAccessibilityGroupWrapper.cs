...
internal sealed class NSAccessibilityGroupWrapper : BaseWrapper, INSAccessibilityGroup, INativeObject, IDisposable, INSAccessibilityElementProtocol
{
	...
	public NSAccessibilityGroupWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
