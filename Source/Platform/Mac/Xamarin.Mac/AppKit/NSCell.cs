...
public class NSCell : NSObject, INSAccessibility, INativeObject, IDisposable, INSAccessibilityElementProtocol, INSCoding, INSCopying, INSUserInterfaceItemIdentification
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selCalcDrawInfo_ = "calcDrawInfo:";

	private static readonly IntPtr selCalcDrawInfo_Handle = Selector.GetHandle("calcDrawInfo:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selCellAttribute_ = "cellAttribute:";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selCellSizeForBounds_ = "cellSizeForBounds:";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selContinueTracking_At_InView_ = "continueTracking:at:inView:";

	private static readonly IntPtr selContinueTracking_At_InView_Handle = Selector.GetHandle("continueTracking:at:inView:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selControlView = "controlView";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selDraggingImageComponentsWithFrame_InView_ = "draggingImageComponentsWithFrame:inView:";

	private static readonly IntPtr selDraggingImageComponentsWithFrame_InView_Handle = Selector.GetHandle("draggingImageComponentsWithFrame:inView:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selDrawFocusRingMaskWithFrame_InView_ = "drawFocusRingMaskWithFrame:inView:";

	private static readonly IntPtr selDrawFocusRingMaskWithFrame_InView_Handle = Selector.GetHandle("drawFocusRingMaskWithFrame:inView:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selDrawInteriorWithFrame_InView_ = "drawInteriorWithFrame:inView:";

	private static readonly IntPtr selDrawInteriorWithFrame_InView_Handle = Selector.GetHandle("drawInteriorWithFrame:inView:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selDrawWithFrame_InView_ = "drawWithFrame:inView:";

	private static readonly IntPtr selDrawWithFrame_InView_Handle = Selector.GetHandle("drawWithFrame:inView:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selDrawingRectForBounds_ = "drawingRectForBounds:";

	private static readonly IntPtr selDrawingRectForBounds_Handle = Selector.GetHandle("drawingRectForBounds:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selEditWithFrame_InView_Editor_Delegate_Event_ = "editWithFrame:inView:editor:delegate:event:";

	private static readonly IntPtr selEditWithFrame_InView_Editor_Delegate_Event_Handle = Selector.GetHandle("editWithFrame:inView:editor:delegate:event:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selExpansionFrameWithFrame_InView_ = "expansionFrameWithFrame:inView:";

	private static readonly IntPtr selExpansionFrameWithFrame_InView_Handle = Selector.GetHandle("expansionFrameWithFrame:inView:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selFieldEditorForView_ = "fieldEditorForView:";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selFocusRingMaskBoundsForFrame_InView_ = "focusRingMaskBoundsForFrame:inView:";

	private static readonly IntPtr selFocusRingMaskBoundsForFrame_InView_Handle = Selector.GetHandle("focusRingMaskBoundsForFrame:inView:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selHasValidObjectValue = "hasValidObjectValue";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selHighlightColorWithFrame_InView_ = "highlightColorWithFrame:inView:";

	private static readonly IntPtr selHighlightColorWithFrame_InView_Handle = Selector.GetHandle("highlightColorWithFrame:inView:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selHitTestForEvent_InRect_OfView_ = "hitTestForEvent:inRect:ofView:";

	private static readonly IntPtr selHitTestForEvent_InRect_OfView_Handle = Selector.GetHandle("hitTestForEvent:inRect:ofView:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selImageRectForBounds_ = "imageRectForBounds:";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selIsEntryAcceptable_ = "isEntryAcceptable:";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selIsScrollable = "isScrollable";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selMenuForEvent_InRect_OfView_ = "menuForEvent:inRect:ofView:";

	private static readonly IntPtr selMenuForEvent_InRect_OfView_Handle = Selector.GetHandle("menuForEvent:inRect:ofView:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selMnemonic = "mnemonic";

	private static readonly IntPtr selMnemonicHandle = Selector.GetHandle("mnemonic");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selMnemonicLocation = "mnemonicLocation";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selNextState = "nextState";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selResetCursorRect_InView_ = "resetCursorRect:inView:";

	private static readonly IntPtr selResetCursorRect_InView_Handle = Selector.GetHandle("resetCursorRect:inView:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSelectWithFrame_InView_Editor_Delegate_Start_Length_ = "selectWithFrame:inView:editor:delegate:start:length:";

	private static readonly IntPtr selSelectWithFrame_InView_Editor_Delegate_Start_Length_Handle = Selector.GetHandle("selectWithFrame:inView:editor:delegate:start:length:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSendsActionOnEndEditing = "sendsActionOnEndEditing";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSetCellAttribute_To_ = "setCellAttribute:to:";

	private static readonly IntPtr selSetCellAttribute_To_Handle = Selector.GetHandle("setCellAttribute:to:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSetControlView_ = "setControlView:";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSetMnemonicLocation_ = "setMnemonicLocation:";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSetSendsActionOnEndEditing_ = "setSendsActionOnEndEditing:";

	private static readonly IntPtr selSetSendsActionOnEndEditing_Handle = Selector.GetHandle("setSendsActionOnEndEditing:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSetShowsFirstResponder_ = "setShowsFirstResponder:";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSetTruncatesLastVisibleLine_ = "setTruncatesLastVisibleLine:";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selShowsFirstResponder = "showsFirstResponder";

	private static readonly IntPtr selShowsFirstResponderHandle = Selector.GetHandle("showsFirstResponder");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selStartTrackingAt_InView_ = "startTrackingAt:inView:";

	private static readonly IntPtr selStartTrackingAt_InView_Handle = Selector.GetHandle("startTrackingAt:inView:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selStopTracking_At_InView_MouseIsUp_ = "stopTracking:at:inView:mouseIsUp:";

	private static readonly IntPtr selStopTracking_At_InView_MouseIsUp_Handle = Selector.GetHandle("stopTracking:at:inView:mouseIsUp:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selTruncatesLastVisibleLine = "truncatesLastVisibleLine";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("NSCell");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[Deprecated(PlatformName.MacOSX, 10, 14, PlatformArchitecture.None, "'ControlTint' property not honored on 10.14. For custom cells, use 'NSColor.ControlAccentColor'.")]
	...
	public virtual NSView ControlView
	{
		...
		get
		{
			...
			if (base.IsDirectBinding)
			{
				return Runtime.GetNSObject<NSView>(Messaging.IntPtr_objc_msgSend(base.Handle, selControlViewHandle));
			}
			return Runtime.GetNSObject<NSView>(Messaging.IntPtr_objc_msgSendSuper(base.SuperHandle, selControlViewHandle));
		}
	...
	public virtual NSFormatter? Formatter
	{
		...
		get
		{
			...
			if (base.IsDirectBinding)
			{
				return Runtime.GetNSObject<NSFormatter>(Messaging.IntPtr_objc_msgSend(base.Handle, selFormatterHandle));
			}
			return Runtime.GetNSObject<NSFormatter>(Messaging.IntPtr_objc_msgSendSuper(base.SuperHandle, selFormatterHandle));
		}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[Deprecated(PlatformName.MacOSX, 10, 8, PlatformArchitecture.All, "Mnemonic methods have typically not been used.")]
	...
	public virtual nint MnemonicLocation
	{
		...
		get
		{
			...
			if (base.IsDirectBinding)
			{
				return Messaging.nint_objc_msgSend(base.Handle, selMnemonicLocationHandle);
			}
			return Messaging.nint_objc_msgSendSuper(base.SuperHandle, selMnemonicLocationHandle);
		}
		[Deprecated(PlatformName.MacOSX, 10, 8, PlatformArchitecture.All, "Mnemonic methods have typically not been used.")]
		...
		set
		{
			...
			if (base.IsDirectBinding)
			{
				Messaging.void_objc_msgSend_nint(base.Handle, selSetMnemonicLocation_Handle, value);
			}
			else
			{
				Messaging.void_objc_msgSendSuper_nint(base.SuperHandle, selSetMnemonicLocation_Handle, value);
			}
		}
	}
	...
	public virtual nint NextState
	{
		...
		get
		{
			...
			if (base.IsDirectBinding)
			{
				return Messaging.nint_objc_msgSend(base.Handle, selNextStateHandle);
			}
			return Messaging.nint_objc_msgSendSuper(base.SuperHandle, selNextStateHandle);
		}
	}
	...
	[Deprecated(PlatformName.MacOSX, 10, 14, PlatformArchitecture.None, "Implement 'ViewDidChangeEffectiveAppearance' on NSView or observe 'NSApplication.EffectiveAppearance'.")]
	...
	private static extern void NSDrawThreePartImage(CGRect rect, IntPtr startCap, IntPtr centerFill, IntPtr endCap, bool vertial, nint op, nfloat alphaFraction, bool flipped);
	...
	{
		NSDrawThreePartImage(frame, startCap?.Handle ?? IntPtr.Zero, centerFill?.Handle ?? IntPtr.Zero, endCap?.Handle ?? IntPtr.Zero, vertical, (nint)(long)op, alphaFraction, flipped);
	}

	[DllImport("/System/Library/Frameworks/AppKit.framework/AppKit")]
	private static extern void NSDrawNinePartImage(CGRect frame, IntPtr topLeftCorner, IntPtr topEdgeFill, IntPtr topRightCorner, IntPtr leftEdgeFill, IntPtr centerFill, IntPtr rightEdgeFill, IntPtr bottomLeftCorner, IntPtr bottomEdgeFill, IntPtr bottomRightCnint, nint op, nfloat alphaFraction, bool flipped);
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected NSCell(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public virtual nint CellAttribute(NSCellAttribute aParameter)
	{
		...
		if (base.IsDirectBinding)
		{
			return Messaging.nint_objc_msgSend_UInt64(base.Handle, selCellAttribute_Handle, (ulong)aParameter);
		}
		return Messaging.nint_objc_msgSendSuper_UInt64(base.SuperHandle, selCellAttribute_Handle, (ulong)aParameter);
	}
	...
	public virtual bool ContinueTracking(CGPoint lastPoint, CGPoint currentPoint, NSView inView)
	{
		...
		if (base.IsDirectBinding)
		{
			return Messaging.bool_objc_msgSend_CGPoint_CGPoint_IntPtr(base.Handle, selContinueTracking_At_InView_Handle, lastPoint, currentPoint, inView.Handle);
		}
		return Messaging.bool_objc_msgSendSuper_CGPoint_CGPoint_IntPtr(base.SuperHandle, selContinueTracking_At_InView_Handle, lastPoint, currentPoint, inView.Handle);
	}
	...
	public virtual void DrawFocusRing(CGRect cellFrameMask, NSView inControlView)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_CGRect_IntPtr(base.Handle, selDrawFocusRingMaskWithFrame_InView_Handle, cellFrameMask, inControlView.Handle);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_CGRect_IntPtr(base.SuperHandle, selDrawFocusRingMaskWithFrame_InView_Handle, cellFrameMask, inControlView.Handle);
		}
	}
	...
	public virtual void DrawInteriorWithFrame(CGRect cellFrame, NSView inView)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_CGRect_IntPtr(base.Handle, selDrawInteriorWithFrame_InView_Handle, cellFrame, inView.Handle);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_CGRect_IntPtr(base.SuperHandle, selDrawInteriorWithFrame_InView_Handle, cellFrame, inView.Handle);
		}
	}
	...
	public virtual void DrawWithExpansionFrame(CGRect cellFrame, NSView inView)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_CGRect_IntPtr(base.Handle, selDrawWithExpansionFrame_InView_Handle, cellFrame, inView.Handle);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_CGRect_IntPtr(base.SuperHandle, selDrawWithExpansionFrame_InView_Handle, cellFrame, inView.Handle);
		}
	}
	...
	public virtual void DrawWithFrame(CGRect cellFrame, NSView inView)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_CGRect_IntPtr(base.Handle, selDrawWithFrame_InView_Handle, cellFrame, inView.Handle);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_CGRect_IntPtr(base.SuperHandle, selDrawWithFrame_InView_Handle, cellFrame, inView.Handle);
		}
	}
	...
	public virtual void EditWithFrame(CGRect aRect, NSView? inView, NSText? editor, NSObject? delegateObject, NSEvent theEvent)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_CGRect_IntPtr_IntPtr_IntPtr_IntPtr(base.Handle, selEditWithFrame_InView_Editor_Delegate_Event_Handle, aRect, inView?.Handle ?? IntPtr.Zero, editor?.Handle ?? IntPtr.Zero, delegateObject?.Handle ?? IntPtr.Zero, theEvent.Handle);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_CGRect_IntPtr_IntPtr_IntPtr_IntPtr(base.SuperHandle, selEditWithFrame_InView_Editor_Delegate_Event_Handle, aRect, inView?.Handle ?? IntPtr.Zero, editor?.Handle ?? IntPtr.Zero, delegateObject?.Handle ?? IntPtr.Zero, theEvent.Handle);
		}
	}
	...
	public virtual CGRect ExpansionFrame(CGRect withFrame, NSView inView)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.CGRect_objc_msgSend_stret_CGRect_IntPtr(out retval, base.Handle, selExpansionFrameWithFrame_InView_Handle, withFrame, inView.Handle);
		}
		else
		{
			Messaging.CGRect_objc_msgSendSuper_stret_CGRect_IntPtr(out retval, base.SuperHandle, selExpansionFrameWithFrame_InView_Handle, withFrame, inView.Handle);
		}
		return retval;
	}
	...
	public virtual NSTextView FieldEditorForView(NSView aControlView)
	{
		...
		if (base.IsDirectBinding)
		{
			return Runtime.GetNSObject<NSTextView>(Messaging.IntPtr_objc_msgSend_IntPtr(base.Handle, selFieldEditorForView_Handle, aControlView.Handle));
		}
		return Runtime.GetNSObject<NSTextView>(Messaging.IntPtr_objc_msgSendSuper_IntPtr(base.SuperHandle, selFieldEditorForView_Handle, aControlView.Handle));
	}
	...
	public virtual NSDraggingImageComponent[] GenerateDraggingImageComponents(CGRect frame, NSView view)
	{
		...
		if (base.IsDirectBinding)
		{
			return NSArray.ArrayFromHandle<NSDraggingImageComponent>(Messaging.IntPtr_objc_msgSend_CGRect_IntPtr(base.Handle, selDraggingImageComponentsWithFrame_InView_Handle, frame, view.Handle));
		}
		return NSArray.ArrayFromHandle<NSDraggingImageComponent>(Messaging.IntPtr_objc_msgSendSuper_CGRect_IntPtr(base.SuperHandle, selDraggingImageComponentsWithFrame_InView_Handle, frame, view.Handle));
	}
	...
	public virtual CGRect GetFocusRingMaskBounds(CGRect cellFrame, NSView controlView)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.CGRect_objc_msgSend_stret_CGRect_IntPtr(out retval, base.Handle, selFocusRingMaskBoundsForFrame_InView_Handle, cellFrame, controlView.Handle);
		}
		else
		{
			Messaging.CGRect_objc_msgSendSuper_stret_CGRect_IntPtr(out retval, base.SuperHandle, selFocusRingMaskBoundsForFrame_InView_Handle, cellFrame, controlView.Handle);
		}
		return retval;
	}
	...
	public virtual void Highlight(bool highlight, CGRect withFrame, NSView inView)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_bool_CGRect_IntPtr(base.Handle, selHighlight_WithFrame_InView_Handle, highlight, withFrame, inView.Handle);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_bool_CGRect_IntPtr(base.SuperHandle, selHighlight_WithFrame_InView_Handle, highlight, withFrame, inView.Handle);
		}
	}
	...
	public virtual NSColor? HighlightColor(CGRect cellFrame, NSView controlView)
	{
		...
		if (base.IsDirectBinding)
		{
			return Runtime.GetNSObject<NSColor>(Messaging.IntPtr_objc_msgSend_CGRect_IntPtr(base.Handle, selHighlightColorWithFrame_InView_Handle, cellFrame, controlView.Handle));
		}
		return Runtime.GetNSObject<NSColor>(Messaging.IntPtr_objc_msgSendSuper_CGRect_IntPtr(base.SuperHandle, selHighlightColorWithFrame_InView_Handle, cellFrame, controlView.Handle));
	}
	...
	public virtual NSCellHit HitTest(NSEvent forEvent, CGRect inRect, NSView ofView)
	{
		...
		if (base.IsDirectBinding)
		{
			return (NSCellHit)Messaging.UInt64_objc_msgSend_IntPtr_CGRect_IntPtr(base.Handle, selHitTestForEvent_InRect_OfView_Handle, forEvent.Handle, inRect, ofView.Handle);
		}
		return (NSCellHit)Messaging.UInt64_objc_msgSendSuper_IntPtr_CGRect_IntPtr(base.SuperHandle, selHitTestForEvent_InRect_OfView_Handle, forEvent.Handle, inRect, ofView.Handle);
	}
	...
	public virtual bool IsEntryAcceptable(string aString)
	{
		...
		IntPtr arg = NSString.CreateNative(aString);
		bool result = ((!base.IsDirectBinding) ? Messaging.bool_objc_msgSendSuper_IntPtr(base.SuperHandle, selIsEntryAcceptable_Handle, arg) : Messaging.bool_objc_msgSend_IntPtr(base.Handle, selIsEntryAcceptable_Handle, arg));
		NSString.ReleaseNative(arg);
		return result;
	}
	...
	public virtual NSMenu MenuForEvent(NSEvent theEvent, CGRect cellFrame, NSView view)
	{
		...
		if (base.IsDirectBinding)
		{
			return Runtime.GetNSObject<NSMenu>(Messaging.IntPtr_objc_msgSend_IntPtr_CGRect_IntPtr(base.Handle, selMenuForEvent_InRect_OfView_Handle, theEvent.Handle, cellFrame, view.Handle));
		}
		return Runtime.GetNSObject<NSMenu>(Messaging.IntPtr_objc_msgSendSuper_IntPtr_CGRect_IntPtr(base.SuperHandle, selMenuForEvent_InRect_OfView_Handle, theEvent.Handle, cellFrame, view.Handle));
	}
	...
	public virtual void ResetCursorRect(CGRect cellFrame, NSView inView)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_CGRect_IntPtr(base.Handle, selResetCursorRect_InView_Handle, cellFrame, inView.Handle);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_CGRect_IntPtr(base.SuperHandle, selResetCursorRect_InView_Handle, cellFrame, inView.Handle);
		}
	}
	...
	public virtual void SelectWithFrame(CGRect aRect, NSView? inView, NSText? editor, NSObject? delegateObject, nint selStart, nint selLength)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_CGRect_IntPtr_IntPtr_IntPtr_nint_nint(base.Handle, selSelectWithFrame_InView_Editor_Delegate_Start_Length_Handle, aRect, inView?.Handle ?? IntPtr.Zero, editor?.Handle ?? IntPtr.Zero, delegateObject?.Handle ?? IntPtr.Zero, selStart, selLength);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_CGRect_IntPtr_IntPtr_IntPtr_nint_nint(base.SuperHandle, selSelectWithFrame_InView_Editor_Delegate_Start_Length_Handle, aRect, inView?.Handle ?? IntPtr.Zero, editor?.Handle ?? IntPtr.Zero, delegateObject?.Handle ?? IntPtr.Zero, selStart, selLength);
		}
	}
	...
	public virtual void SetCellAttribute(NSCellAttribute aParameter, nint value)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_UInt64_nint(base.Handle, selSetCellAttribute_To_Handle, (ulong)aParameter, value);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_UInt64_nint(base.SuperHandle, selSetCellAttribute_To_Handle, (ulong)aParameter, value);
		}
	}
	...
	public virtual bool StartTracking(CGPoint startPoint, NSView inView)
	{
		...
		if (base.IsDirectBinding)
		{
			return Messaging.bool_objc_msgSend_CGPoint_IntPtr(base.Handle, selStartTrackingAt_InView_Handle, startPoint, inView.Handle);
		}
		return Messaging.bool_objc_msgSendSuper_CGPoint_IntPtr(base.SuperHandle, selStartTrackingAt_InView_Handle, startPoint, inView.Handle);
	}
	...
	public virtual void StopTracking(CGPoint lastPoint, CGPoint stopPoint, NSView inView, bool mouseIsUp)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_CGPoint_CGPoint_IntPtr_bool(base.Handle, selStopTracking_At_InView_MouseIsUp_Handle, lastPoint, stopPoint, inView.Handle, mouseIsUp);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_CGPoint_CGPoint_IntPtr_bool(base.SuperHandle, selStopTracking_At_InView_MouseIsUp_Handle, lastPoint, stopPoint, inView.Handle, mouseIsUp);
		}
	}
