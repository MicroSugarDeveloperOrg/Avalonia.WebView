...
public class NSSliderAccessory : NSObject, INSAccessibility, INativeObject, IDisposable, INSAccessibilityElementProtocol, INSCoding
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selAccessoryWithImage_ = "accessoryWithImage:";

	private static readonly IntPtr selAccessoryWithImage_Handle = Selector.GetHandle("accessoryWithImage:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("NSSliderAccessory");
	...
	public virtual NSSliderAccessoryBehavior Behavior
	{
		...
		get
		{
			...
			if (base.IsDirectBinding)
			{
				return Runtime.GetNSObject<NSSliderAccessoryBehavior>(Messaging.IntPtr_objc_msgSend(base.Handle, selBehaviorHandle));
			}
			return Runtime.GetNSObject<NSSliderAccessoryBehavior>(Messaging.IntPtr_objc_msgSendSuper(base.SuperHandle, selBehaviorHandle));
		}
		...
		set
		{
			...
			if (base.IsDirectBinding)
			{
				Messaging.void_objc_msgSend_IntPtr(base.Handle, selSetBehavior_Handle, value.Handle);
			}
			else
			{
				Messaging.void_objc_msgSendSuper_IntPtr(base.SuperHandle, selSetBehavior_Handle, value.Handle);
			}
		}
	}
	...
	public NSSliderAccessory(NSCoder coder)
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected NSSliderAccessory(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal NSSliderAccessory(IntPtr handle)
		: base(handle)
	{
	}
	...
	public static NSSliderAccessory CreateAccessory(NSImage image)
	{
		...
		return Runtime.GetNSObject<NSSliderAccessory>(Messaging.IntPtr_objc_msgSend_IntPtr(class_ptr, selAccessoryWithImage_Handle, image.Handle));
	}
