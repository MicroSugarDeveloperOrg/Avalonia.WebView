...
internal sealed class NSAccessibilityStaticTextWrapper : BaseWrapper, INSAccessibilityStaticText, INativeObject, IDisposable, INSAccessibilityElementProtocol
{
	...
	public NSAccessibilityStaticTextWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
