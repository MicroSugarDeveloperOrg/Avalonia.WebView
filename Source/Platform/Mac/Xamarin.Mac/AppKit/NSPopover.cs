...
public class NSPopover : NSResponder, INSAccessibility, INativeObject, IDisposable, INSAccessibilityElementProtocol, INSAppearanceCustomization
{
	public static class Notifications
	{
		...
		{
			EventHandler<NSPopoverCloseEventArgs> handler2 = handler;
			return NSNotificationCenter.DefaultCenter.AddObserver(DidCloseNotification, delegate(NSNotification notification)
			{
				handler2(null, new NSPopoverCloseEventArgs(notification));
			});
		}

		public static NSObject ObserveDidClose(NSObject objectToObserve, EventHandler<NSPopoverCloseEventArgs> handler)
		{
			EventHandler<NSPopoverCloseEventArgs> handler2 = handler;
			return NSNotificationCenter.DefaultCenter.AddObserver(DidCloseNotification, delegate(NSNotification notification)
			{
		...
		public static NSObject ObserveDidShow(NSObject objectToObserve, EventHandler<NSNotificationEventArgs> handler)
		{
			EventHandler<NSNotificationEventArgs> handler2 = handler;
			return NSNotificationCenter.DefaultCenter.AddObserver(DidShowNotification, delegate(NSNotification notification)
			{
		...
		public static NSObject ObserveWillClose(NSObject objectToObserve, EventHandler<NSPopoverCloseEventArgs> handler)
		{
			EventHandler<NSPopoverCloseEventArgs> handler2 = handler;
			return NSNotificationCenter.DefaultCenter.AddObserver(WillCloseNotification, delegate(NSNotification notification)
			{
		...
		public static NSObject ObserveWillShow(NSObject objectToObserve, EventHandler<NSNotificationEventArgs> handler)
		{
			EventHandler<NSNotificationEventArgs> handler2 = handler;
			return NSNotificationCenter.DefaultCenter.AddObserver(WillShowNotification, delegate(NSNotification notification)
			{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selIsShown = "isShown";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selPositioningRect = "positioningRect";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSetPositioningRect_ = "setPositioningRect:";
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("NSPopover");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[Obsolete("Use 'GetAppearance' and 'SetAppearance' methods instead.", false)]
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public INSPopoverDelegate Delegate
	{
		get
		{
			return WeakDelegate as INSPopoverDelegate;
		}
		set
		{
	...
	[Advice("Use NSPopover.Notifications.ObserveAnnouncementRequested helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveApplicationActivated helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveApplicationDeactivated helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveApplicationHidden helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveApplicationShown helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveCreated helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveDidClose helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveDidShow helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveDrawerCreated helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveFocusedWindowChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveHelpTagCreated helper method instead.")]
	...
	[Introduced(PlatformName.MacOSX, 10, 9, PlatformArchitecture.All, null)]
	[Advice("Use NSPopover.Notifications.ObserveLayoutChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveMainWindowChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveMoved helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveResized helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveRowCollapsed helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveRowCountChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveRowExpanded helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveSelectedCellsChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveSelectedChildrenChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveSelectedChildrenMoved helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveSelectedColumnsChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveSelectedRowsChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveSelectedTextChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveSheetCreated helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveTitleChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveUIElementDestroyed helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveUIElementFocusedChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveUnitsChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveValueChanged helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveWillClose helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveWillShow helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveWindowCreated helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveWindowDeminiaturized helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveWindowMiniaturized helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveWindowMoved helper method instead.")]
	...
	[Advice("Use NSPopover.Notifications.ObserveWindowResized helper method instead.")]
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected NSPopover(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public virtual void Show(CGRect relativePositioningRect, NSView positioningView, NSRectEdge preferredEdge)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_CGRect_IntPtr_UInt64(base.Handle, selShowRelativeToRect_OfView_PreferredEdge_Handle, relativePositioningRect, positioningView.Handle, (ulong)preferredEdge);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_CGRect_IntPtr_UInt64(base.SuperHandle, selShowRelativeToRect_OfView_PreferredEdge_Handle, relativePositioningRect, positioningView.Handle, (ulong)preferredEdge);
		}
	}
