...
internal sealed class NSAccessibilitySwitchWrapper : BaseWrapper, INSAccessibilitySwitch, INativeObject, IDisposable, INSAccessibilityButton, INSAccessibilityElementProtocol
{
	...
	public NSAccessibilitySwitchWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
