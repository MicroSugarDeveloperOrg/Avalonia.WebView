...
[Protocol]
[Register("NSWindowDelegate", false)]
[Model]
public class NSWindowDelegate : NSObject, INSWindowDelegate, INativeObject, IDisposable
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected NSWindowDelegate(NSObjectFlag t)
		: base(t)
	{
		base.IsDirectBinding = false;
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal NSWindowDelegate(IntPtr handle)
		: base(handle)
	{
		base.IsDirectBinding = false;
	}
