...
internal sealed class NSAccessibilityProgressIndicatorWrapper : BaseWrapper, INSAccessibilityProgressIndicator, INativeObject, IDisposable, INSAccessibilityElementProtocol, INSAccessibilityGroup
{
	...
	public NSAccessibilityProgressIndicatorWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
