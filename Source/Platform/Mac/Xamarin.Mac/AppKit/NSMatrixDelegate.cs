...
[Protocol]
[Register("NSMatrixDelegate", false)]
[Model]
public class NSMatrixDelegate : NSObject, INSMatrixDelegate, INativeObject, IDisposable, INSControlTextEditingDelegate
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected NSMatrixDelegate(NSObjectFlag t)
		: base(t)
	{
		base.IsDirectBinding = false;
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal NSMatrixDelegate(IntPtr handle)
		: base(handle)
	{
		base.IsDirectBinding = false;
	}
