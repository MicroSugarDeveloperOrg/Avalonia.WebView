...
internal sealed class NSAccessibilityOutlineWrapper : BaseWrapper, INSAccessibilityOutline, INativeObject, IDisposable, INSAccessibilityElementProtocol, INSAccessibilityGroup, INSAccessibilityTable
{
	...
	public NSAccessibilityOutlineWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
