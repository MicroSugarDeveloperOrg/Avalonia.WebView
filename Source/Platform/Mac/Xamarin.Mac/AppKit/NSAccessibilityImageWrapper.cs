...
internal sealed class NSAccessibilityImageWrapper : BaseWrapper, INSAccessibilityImage, INativeObject, IDisposable, INSAccessibilityElementProtocol
{
	...
	public NSAccessibilityImageWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
