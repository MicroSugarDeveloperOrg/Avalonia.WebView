...
internal sealed class NSAccessibilityCheckBoxWrapper : BaseWrapper, INSAccessibilityCheckBox, INativeObject, IDisposable, INSAccessibilityButton, INSAccessibilityElementProtocol
{
	...
	public NSAccessibilityCheckBoxWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
