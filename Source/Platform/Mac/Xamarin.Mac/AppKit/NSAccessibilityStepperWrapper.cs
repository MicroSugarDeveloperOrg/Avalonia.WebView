...
internal sealed class NSAccessibilityStepperWrapper : BaseWrapper, INSAccessibilityStepper, INativeObject, IDisposable, INSAccessibilityElementProtocol
{
	...
	public NSAccessibilityStepperWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
