...
public class NEFilterNewFlowVerdict : NEFilterVerdict, INSCoding, INativeObject, IDisposable, INSCopying, INSSecureCoding
{
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selURLAppendStringVerdictWithMapKey_ = "URLAppendStringVerdictWithMapKey:";

	private static readonly IntPtr selURLAppendStringVerdictWithMapKey_Handle = Selector.GetHandle("URLAppendStringVerdictWithMapKey:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selFilterDataVerdictWithFilterInbound_PeekInboundBytes_FilterOutbound_PeekOutboundBytes_ = "filterDataVerdictWithFilterInbound:peekInboundBytes:filterOutbound:peekOutboundBytes:";

	private static readonly IntPtr selFilterDataVerdictWithFilterInbound_PeekInboundBytes_FilterOutbound_PeekOutboundBytes_Handle = Selector.GetHandle("filterDataVerdictWithFilterInbound:peekInboundBytes:filterOutbound:peekOutboundBytes:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("NEFilterNewFlowVerdict");
	...
	public NEFilterNewFlowVerdict(NSCoder coder)
		: base(NSObjectFlag.Empty)
	{
		if (base.IsDirectBinding)
		{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected NEFilterNewFlowVerdict(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal NEFilterNewFlowVerdict(IntPtr handle)
		: base(handle)
	{
	}
	...
	{
		return Runtime.GetNSObject<NEFilterNewFlowVerdict>(Messaging.IntPtr_objc_msgSend(class_ptr, selAllowVerdictHandle));
	}
	...
	{
		return Runtime.GetNSObject<NEFilterNewFlowVerdict>(Messaging.IntPtr_objc_msgSend(class_ptr, selDropVerdictHandle));
	}
	...
	{
		return Runtime.GetNSObject<NEFilterNewFlowVerdict>(Messaging.IntPtr_objc_msgSend_bool_nuint_bool_nuint(class_ptr, selFilterDataVerdictWithFilterInbound_PeekInboundBytes_FilterOutbound_PeekOutboundBytes_Handle, filterInbound, peekInboundBytes, filterOutbound, peekOutboundBytes));
	}
	...
	{
		return Runtime.GetNSObject<NEFilterNewFlowVerdict>(Messaging.IntPtr_objc_msgSend(class_ptr, selNeedRulesVerdictHandle));
	}
	...
	{
		if (remediationUrlMapKey == null)
		{
			throw new ArgumentNullException("remediationUrlMapKey");
		}
		if (remediationButtonTextMapKey == null)
		{
			throw new ArgumentNullException("remediationButtonTextMapKey");
		}
		IntPtr arg = NSString.CreateNative(remediationUrlMapKey);
		IntPtr arg2 = NSString.CreateNative(remediationButtonTextMapKey);
		NEFilterNewFlowVerdict nSObject = Runtime.GetNSObject<NEFilterNewFlowVerdict>(Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr(class_ptr, selRemediateVerdictWithRemediationURLMapKey_RemediationButtonTextMapKey_Handle, arg, arg2));
	...
	{
		if (urlAppendMapKey == null)
		{
			throw new ArgumentNullException("urlAppendMapKey");
		}
		IntPtr arg = NSString.CreateNative(urlAppendMapKey);
		NEFilterNewFlowVerdict nSObject = Runtime.GetNSObject<NEFilterNewFlowVerdict>(Messaging.IntPtr_objc_msgSend_IntPtr(class_ptr, selURLAppendStringVerdictWithMapKey_Handle, arg));
		NSString.ReleaseNative(arg);
		return nSObject;
	}
}
