...
public class MDLBundleAssetResolver : NSObject, IMDLAssetResolver, INativeObject, IDisposable
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selInitWithBundle_ = "initWithBundle:";

	private static readonly IntPtr selInitWithBundle_Handle = Selector.GetHandle("initWithBundle:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MDLBundleAssetResolver");
	...
	protected MDLBundleAssetResolver(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MDLBundleAssetResolver(IntPtr handle)
		: base(handle)
	{
	}
		...
		: base(NSObjectFlag.Empty)
	{
		...
		if (base.IsDirectBinding)
		{
			InitializeHandle(Messaging.IntPtr_objc_msgSend_IntPtr(base.Handle, selInitWithBundle_Handle, arg), "initWithBundle:");
		}
		else
		{
			InitializeHandle(Messaging.IntPtr_objc_msgSendSuper_IntPtr(base.SuperHandle, selInitWithBundle_Handle, arg), "initWithBundle:");
		}
		NSString.ReleaseNative(arg);
	}
