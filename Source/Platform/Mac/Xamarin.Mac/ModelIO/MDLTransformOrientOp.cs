...
public class MDLTransformOrientOp : NSObject, IMDLTransformOp, INativeObject, IDisposable
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MDLTransformOrientOp");
	...
	public virtual MDLAnimatedQuaternion AnimatedValue
	{
		...
		get
		{
			...
			{
				return Runtime.GetNSObject<MDLAnimatedQuaternion>(Messaging.IntPtr_objc_msgSend(base.Handle, selAnimatedValueHandle));
			}
			return Runtime.GetNSObject<MDLAnimatedQuaternion>(Messaging.IntPtr_objc_msgSendSuper(base.SuperHandle, selAnimatedValueHandle));
		}
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MDLTransformOrientOp(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MDLTransformOrientOp(IntPtr handle)
		: base(handle)
	{
	}
