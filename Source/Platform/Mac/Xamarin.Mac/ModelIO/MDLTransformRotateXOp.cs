...
public class MDLTransformRotateXOp : NSObject, IMDLTransformOp, INativeObject, IDisposable
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MDLTransformRotateXOp");
	...
	public virtual MDLAnimatedScalar AnimatedValue
	{
		...
		get
		{
			...
			{
				return Runtime.GetNSObject<MDLAnimatedScalar>(Messaging.IntPtr_objc_msgSend(base.Handle, selAnimatedValueHandle));
			}
			return Runtime.GetNSObject<MDLAnimatedScalar>(Messaging.IntPtr_objc_msgSendSuper(base.SuperHandle, selAnimatedValueHandle));
		}
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MDLTransformRotateXOp(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MDLTransformRotateXOp(IntPtr handle)
		: base(handle)
	{
	}
