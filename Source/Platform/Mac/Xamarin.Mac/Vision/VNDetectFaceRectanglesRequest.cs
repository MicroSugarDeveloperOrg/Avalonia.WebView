...
public class VNDetectFaceRectanglesRequest : VNImageBasedRequest
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("VNDetectFaceRectanglesRequest");
	...
	public static VNDetectFaceRectanglesRequestRevision CurrentRevision
	{
		...
		get
		{
			return (VNDetectFaceRectanglesRequestRevision)Messaging.UInt64_objc_msgSend(class_ptr, selCurrentRevisionHandle);
		}
	}
	...
	public static VNDetectFaceRectanglesRequestRevision DefaultRevision
	{
		...
		get
		{
			return (VNDetectFaceRectanglesRequestRevision)Messaging.UInt64_objc_msgSend(class_ptr, selDefaultRevisionHandle);
		}
	}
	...
	public virtual VNDetectFaceRectanglesRequestRevision Revision
	{
		...
		get
		{
			...
			{
				return (VNDetectFaceRectanglesRequestRevision)Messaging.UInt64_objc_msgSend(base.Handle, selRevisionHandle);
			}
			return (VNDetectFaceRectanglesRequestRevision)Messaging.UInt64_objc_msgSendSuper(base.SuperHandle, selRevisionHandle);
		}
		[Introduced(PlatformName.TvOS, 12, 0, PlatformArchitecture.All, null)]
		[Introduced(PlatformName.MacOSX, 10, 14, PlatformArchitecture.All, null)]
		[Introduced(PlatformName.iOS, 12, 0, PlatformArchitecture.All, null)]
	...
	public static VNDetectFaceRectanglesRequestRevision[] SupportedRevisions
	{
		...
		get
		{
			return VNRequest.GetSupportedVersions<VNDetectFaceRectanglesRequestRevision>(WeakSupportedRevisions);
		}
	}
	...
	protected VNDetectFaceRectanglesRequest(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal VNDetectFaceRectanglesRequest(IntPtr handle)
		: base(handle)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public unsafe VNDetectFaceRectanglesRequest([BlockProxy(typeof(Trampolines.NIDVNRequestCompletionHandler))] VNRequestCompletionHandler? completionHandler)
