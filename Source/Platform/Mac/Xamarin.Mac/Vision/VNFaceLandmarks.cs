...
public abstract class VNFaceLandmarks : NSObject, INSCoding, INativeObject, IDisposable, INSCopying, INSSecureCoding, IVNRequestRevisionProviding
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("VNFaceLandmarks");
	...
	protected VNFaceLandmarks(NSCoder coder)
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected VNFaceLandmarks(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal VNFaceLandmarks(IntPtr handle)
		: base(handle)
	{
	}
