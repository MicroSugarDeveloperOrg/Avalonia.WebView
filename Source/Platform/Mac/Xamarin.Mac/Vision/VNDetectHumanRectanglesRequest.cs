...
public class VNDetectHumanRectanglesRequest : VNImageBasedRequest
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("VNDetectHumanRectanglesRequest");
	...
	public static VNDetectHumanRectanglesRequestRevision CurrentRevision
	{
		...
		get
		{
			return (VNDetectHumanRectanglesRequestRevision)Messaging.UInt64_objc_msgSend(class_ptr, selCurrentRevisionHandle);
		}
	}
	...
	public static VNDetectHumanRectanglesRequestRevision DefaultRevision
	{
		...
		get
		{
			return (VNDetectHumanRectanglesRequestRevision)Messaging.UInt64_objc_msgSend(class_ptr, selDefaultRevisionHandle);
		}
	}
	...
	public virtual VNDetectHumanRectanglesRequestRevision Revision
	{
		...
		get
		{
			...
			{
				return (VNDetectHumanRectanglesRequestRevision)Messaging.UInt64_objc_msgSend(base.Handle, selRevisionHandle);
			}
			return (VNDetectHumanRectanglesRequestRevision)Messaging.UInt64_objc_msgSendSuper(base.SuperHandle, selRevisionHandle);
		}
		[Export("setRevision:")]
		set
		{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public static VNDetectHumanRectanglesRequestRevision[] SupportedRevisions => VNRequest.GetSupportedVersions<VNDetectHumanRectanglesRequestRevision>(WeakSupportedRevisions);
	...
	protected VNDetectHumanRectanglesRequest(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal VNDetectHumanRectanglesRequest(IntPtr handle)
		: base(handle)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public unsafe VNDetectHumanRectanglesRequest([BlockProxy(typeof(Trampolines.NIDVNRequestCompletionHandler))] VNRequestCompletionHandler? completionHandler)
