...
public class VNDetectFaceLandmarksRequest : VNImageBasedRequest, IVNFaceObservationAccepting, INativeObject, IDisposable
{
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selConstellation = "constellation";

	private static readonly IntPtr selConstellationHandle = Selector.GetHandle("constellation");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selRevision_SupportsConstellation_ = "revision:supportsConstellation:";

	private static readonly IntPtr selRevision_SupportsConstellation_Handle = Selector.GetHandle("revision:supportsConstellation:");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSetConstellation_ = "setConstellation:";

	private static readonly IntPtr selSetConstellation_Handle = Selector.GetHandle("setConstellation:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("VNDetectFaceLandmarksRequest");
	...
	public virtual VNRequestFaceLandmarksConstellation Constellation
	{
		...
		get
		{
			...
			{
				return (VNRequestFaceLandmarksConstellation)Messaging.UInt64_objc_msgSend(base.Handle, selConstellationHandle);
			}
			return (VNRequestFaceLandmarksConstellation)Messaging.UInt64_objc_msgSendSuper(base.SuperHandle, selConstellationHandle);
		}
		[Introduced(PlatformName.TvOS, 13, 0, PlatformArchitecture.All, null)]
		[Introduced(PlatformName.MacOSX, 10, 15, PlatformArchitecture.All, null)]
		[Introduced(PlatformName.iOS, 13, 0, PlatformArchitecture.All, null)]
		...
		set
		{
			if (base.IsDirectBinding)
			{
				Messaging.void_objc_msgSend_UInt64(base.Handle, selSetConstellation_Handle, (ulong)value);
			}
			else
			{
				Messaging.void_objc_msgSendSuper_UInt64(base.SuperHandle, selSetConstellation_Handle, (ulong)value);
			}
		}
	}
	...
	public static VNDetectFaceLandmarksRequestRevision CurrentRevision
	{
		...
		get
		{
			return (VNDetectFaceLandmarksRequestRevision)Messaging.UInt64_objc_msgSend(class_ptr, selCurrentRevisionHandle);
		}
	}
	...
	public static VNDetectFaceLandmarksRequestRevision DefaultRevision
	{
		...
		get
		{
			return (VNDetectFaceLandmarksRequestRevision)Messaging.UInt64_objc_msgSend(class_ptr, selDefaultRevisionHandle);
		}
	}
	...
	public virtual VNDetectFaceLandmarksRequestRevision Revision
	{
		...
		get
		{
			if (base.IsDirectBinding)
			{
				return (VNDetectFaceLandmarksRequestRevision)Messaging.UInt64_objc_msgSend(base.Handle, selRevisionHandle);
			}
			return (VNDetectFaceLandmarksRequestRevision)Messaging.UInt64_objc_msgSendSuper(base.SuperHandle, selRevisionHandle);
		}
		[Introduced(PlatformName.TvOS, 12, 0, PlatformArchitecture.All, null)]
		[Introduced(PlatformName.MacOSX, 10, 14, PlatformArchitecture.All, null)]
		[Introduced(PlatformName.iOS, 12, 0, PlatformArchitecture.All, null)]
	...
	public static VNDetectFaceLandmarksRequestRevision[] SupportedRevisions
	{
		...
		get
		{
			return VNRequest.GetSupportedVersions<VNDetectFaceLandmarksRequestRevision>(WeakSupportedRevisions);
		}
	}
	...
	protected VNDetectFaceLandmarksRequest(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal VNDetectFaceLandmarksRequest(IntPtr handle)
		: base(handle)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public unsafe VNDetectFaceLandmarksRequest([BlockProxy(typeof(Trampolines.NIDVNRequestCompletionHandler))] VNRequestCompletionHandler? completionHandler)
	...
	{
		return Messaging.bool_objc_msgSend_UInt64_UInt64(class_ptr, selRevision_SupportsConstellation_Handle, (ulong)revision, (ulong)constellation);
	}
}
