...
public class MTLVertexAttributeDescriptor : NSObject, INSCopying, INativeObject, IDisposable
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MTLVertexAttributeDescriptor");
	...
	public virtual MTLVertexFormat Format
	{
		...
		get
		{
			if (base.IsDirectBinding)
			{
				return (MTLVertexFormat)Messaging.UInt64_objc_msgSend(base.Handle, selFormatHandle);
			}
			return (MTLVertexFormat)Messaging.UInt64_objc_msgSendSuper(base.SuperHandle, selFormatHandle);
		}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MTLVertexAttributeDescriptor(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MTLVertexAttributeDescriptor(IntPtr handle)
		: base(handle)
	{
	}
