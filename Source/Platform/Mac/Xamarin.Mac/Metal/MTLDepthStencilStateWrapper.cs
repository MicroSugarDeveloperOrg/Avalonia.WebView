...
internal sealed class MTLDepthStencilStateWrapper : BaseWrapper, IMTLDepthStencilState, INativeObject, IDisposable
{
	...
	public MTLDepthStencilStateWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
