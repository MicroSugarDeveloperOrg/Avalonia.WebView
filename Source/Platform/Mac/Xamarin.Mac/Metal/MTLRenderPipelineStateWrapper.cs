...
internal sealed class MTLRenderPipelineStateWrapper : BaseWrapper, IMTLRenderPipelineState, INativeObject, IDisposable
{
	...
	public MTLRenderPipelineStateWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
