...
[Register("CWMutableNetworkProfile", true)]
public class CWMutableNetworkProfile : CWNetworkProfile, INSCoding, INativeObject, IDisposable, INSCopying, INSMutableCopying, INSSecureCoding
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("CWMutableNetworkProfile");
	...
	public CWMutableNetworkProfile(NSCoder coder)
		: base(NSObjectFlag.Empty)
	{
		if (base.IsDirectBinding)
		{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected CWMutableNetworkProfile(NSObjectFlag t)
		: base(t)
	{
	}
