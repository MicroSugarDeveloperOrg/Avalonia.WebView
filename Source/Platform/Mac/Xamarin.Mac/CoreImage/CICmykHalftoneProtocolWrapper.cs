...
internal sealed class CICmykHalftoneProtocolWrapper : BaseWrapper, ICICmykHalftoneProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public float GrayComponentReplacement
	{
		...
		get
		{
			return Messaging.float_objc_msgSend(base.Handle, Selector.GetHandle("grayComponentReplacement"));
		}
		[Export("setGrayComponentReplacement:")]
		set
		{
			Messaging.void_objc_msgSend_float(base.Handle, Selector.GetHandle("setGrayComponentReplacement:"), value);
		}
	}
	...
	public float UnderColorRemoval
	{
		...
		get
		{
			return Messaging.float_objc_msgSend(base.Handle, Selector.GetHandle("underColorRemoval"));
		}
		[Export("setUnderColorRemoval:")]
		set
		{
			Messaging.void_objc_msgSend_float(base.Handle, Selector.GetHandle("setUnderColorRemoval:"), value);
		}
	}
	...
	public CICmykHalftoneProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
