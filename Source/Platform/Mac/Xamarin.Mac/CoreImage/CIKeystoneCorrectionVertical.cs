...
public class CIKeystoneCorrectionVertical : CIKeystoneCorrection, ICIKeystoneCorrectionVerticalProtocol, INativeObject, IDisposable, ICIFilterProtocol, ICIFourCoordinateGeometryFilterProtocol
{
	...
	public CIKeystoneCorrectionVertical()
		: base("CIKeystoneCorrectionVertical")
	{
	}
	...
	protected CIKeystoneCorrectionVertical(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIKeystoneCorrectionVertical(NSCoder coder)
