...
public class CIFourfoldRotatedTile : CITileFilter, ICIFourfoldRotatedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIFourfoldRotatedTile(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIFourfoldRotatedTile(NSCoder coder)
