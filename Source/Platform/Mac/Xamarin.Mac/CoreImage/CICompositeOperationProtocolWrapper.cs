...
internal sealed class CICompositeOperationProtocolWrapper : BaseWrapper, ICICompositeOperationProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CICompositeOperationProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
