...
internal sealed class CIBloomProtocolWrapper : BaseWrapper, ICIBloomProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIBloomProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
