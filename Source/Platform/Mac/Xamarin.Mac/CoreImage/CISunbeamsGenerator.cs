...
public class CISunbeamsGenerator : CIFilter, ICISunbeamsGeneratorProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CISunbeamsGenerator(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CISunbeamsGenerator(NSCoder coder)
