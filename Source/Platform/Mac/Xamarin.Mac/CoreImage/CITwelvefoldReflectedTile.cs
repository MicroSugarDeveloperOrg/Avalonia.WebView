...
public class CITwelvefoldReflectedTile : CITileFilter, ICITwelvefoldReflectedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CITwelvefoldReflectedTile(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CITwelvefoldReflectedTile(NSCoder coder)
