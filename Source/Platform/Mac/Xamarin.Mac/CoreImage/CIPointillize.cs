...
public class CIPointillize : CIFilter, ICIPointillizeProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIPointillize(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIPointillize(NSCoder coder)
