...
internal sealed class CIGloomProtocolWrapper : BaseWrapper, ICIGloomProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIGloomProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
