...
public class CIHatchedScreen : CIScreenFilter, ICIHatchedScreenProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIHatchedScreen(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIHatchedScreen(NSCoder coder)
