...
internal sealed class CIFourfoldTranslatedTileProtocolWrapper : BaseWrapper, ICIFourfoldTranslatedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public float AcuteAngle
	{
		...
		get
		{
			return Messaging.float_objc_msgSend(base.Handle, Selector.GetHandle("acuteAngle"));
		}
		[Export("setAcuteAngle:")]
		set
		{
			Messaging.void_objc_msgSend_float(base.Handle, Selector.GetHandle("setAcuteAngle:"), value);
		}
	}
	...
	public CIFourfoldTranslatedTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
