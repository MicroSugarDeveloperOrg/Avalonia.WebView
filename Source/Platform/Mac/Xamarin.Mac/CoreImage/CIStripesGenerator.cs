...
public class CIStripesGenerator : CIFilter, ICIStripesGeneratorProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIStripesGenerator(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIStripesGenerator(NSCoder coder)
