...
internal sealed class CICircularScreenProtocolWrapper : BaseWrapper, ICICircularScreenProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CICircularScreenProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
