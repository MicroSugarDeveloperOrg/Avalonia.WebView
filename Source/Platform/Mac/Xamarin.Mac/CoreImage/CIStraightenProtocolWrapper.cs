...
internal sealed class CIStraightenProtocolWrapper : BaseWrapper, ICIStraightenProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIStraightenProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
