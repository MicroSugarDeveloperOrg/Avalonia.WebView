...
internal sealed class CIZoomBlurProtocolWrapper : BaseWrapper, ICIZoomBlurProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIZoomBlurProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
