...
internal sealed class CICrystallizeProtocolWrapper : BaseWrapper, ICICrystallizeProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CICrystallizeProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
