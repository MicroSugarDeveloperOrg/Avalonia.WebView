...
internal sealed class CIMaximumComponentProtocolWrapper : BaseWrapper, ICIMaximumComponentProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIMaximumComponentProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
