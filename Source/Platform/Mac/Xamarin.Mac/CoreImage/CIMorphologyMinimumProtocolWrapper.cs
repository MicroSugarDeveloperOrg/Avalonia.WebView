...
internal sealed class CIMorphologyMinimumProtocolWrapper : BaseWrapper, ICIMorphologyMinimumProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIMorphologyMinimumProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
