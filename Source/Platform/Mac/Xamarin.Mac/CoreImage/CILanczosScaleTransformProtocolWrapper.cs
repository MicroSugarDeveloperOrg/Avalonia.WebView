...
internal sealed class CILanczosScaleTransformProtocolWrapper : BaseWrapper, ICILanczosScaleTransformProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CILanczosScaleTransformProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
