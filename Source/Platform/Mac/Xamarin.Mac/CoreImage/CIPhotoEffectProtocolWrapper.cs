...
internal sealed class CIPhotoEffectProtocolWrapper : BaseWrapper, ICIPhotoEffectProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIPhotoEffectProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
