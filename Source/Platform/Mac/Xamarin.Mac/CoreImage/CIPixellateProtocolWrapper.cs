...
internal sealed class CIPixellateProtocolWrapper : BaseWrapper, ICIPixellateProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIPixellateProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
