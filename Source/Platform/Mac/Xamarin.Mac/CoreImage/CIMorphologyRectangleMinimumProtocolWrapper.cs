...
internal sealed class CIMorphologyRectangleMinimumProtocolWrapper : BaseWrapper, ICIMorphologyRectangleMinimumProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIMorphologyRectangleMinimumProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
