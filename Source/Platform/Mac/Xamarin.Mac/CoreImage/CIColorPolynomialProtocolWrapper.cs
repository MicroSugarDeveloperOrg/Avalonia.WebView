...
internal sealed class CIColorPolynomialProtocolWrapper : BaseWrapper, ICIColorPolynomialProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIVector AlphaCoefficients
	{
		...
		get
		{
			return Runtime.GetNSObject<CIVector>(Messaging.IntPtr_objc_msgSend(base.Handle, Selector.GetHandle("alphaCoefficients")));
		}
		...
		set
		{
			...
			Messaging.void_objc_msgSend_IntPtr(base.Handle, Selector.GetHandle("setAlphaCoefficients:"), value.Handle);
		}
	}
	...
	public CIColorPolynomialProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
