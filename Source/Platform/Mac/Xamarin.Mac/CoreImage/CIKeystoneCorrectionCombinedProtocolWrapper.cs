...
internal sealed class CIKeystoneCorrectionCombinedProtocolWrapper : BaseWrapper, ICIKeystoneCorrectionCombinedProtocol, INativeObject, IDisposable, ICIFilterProtocol, ICIFourCoordinateGeometryFilterProtocol
{
	...
	public CIKeystoneCorrectionCombinedProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
