...
internal sealed class CIColorInvertProtocolWrapper : BaseWrapper, ICIColorInvertProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIColorInvertProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
