...
public class CIFourfoldTranslatedTile : CITileFilter, ICIFourfoldTranslatedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIFourfoldTranslatedTile(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIFourfoldTranslatedTile(NSCoder coder)
