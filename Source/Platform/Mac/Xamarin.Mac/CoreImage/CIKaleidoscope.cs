...
public class CIKaleidoscope : CIFilter, ICIKaleidoscopeProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	[Obsolete("Use 'InputCount' instead.", false)]
	...
	protected CIKaleidoscope(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIKaleidoscope(NSCoder coder)
