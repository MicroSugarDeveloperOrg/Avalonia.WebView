...
internal sealed class CIComicEffectProtocolWrapper : BaseWrapper, ICIComicEffectProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIComicEffectProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
