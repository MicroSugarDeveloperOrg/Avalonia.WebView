...
internal sealed class CIColorMonochromeProtocolWrapper : BaseWrapper, ICIColorMonochromeProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIColorMonochromeProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
