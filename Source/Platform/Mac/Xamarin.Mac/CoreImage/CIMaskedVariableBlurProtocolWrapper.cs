...
internal sealed class CIMaskedVariableBlurProtocolWrapper : BaseWrapper, ICIMaskedVariableBlurProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIImage? Mask
	{
		...
		get
		{
			return Runtime.GetNSObject<CIImage>(Messaging.IntPtr_objc_msgSend(base.Handle, Selector.GetHandle("mask")));
		}
		[Export("setMask:", ArgumentSemantic.Retain)]
		set
		{
			Messaging.void_objc_msgSend_IntPtr(base.Handle, Selector.GetHandle("setMask:"), value?.Handle ?? IntPtr.Zero);
		}
	}
	...
	public CIMaskedVariableBlurProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
