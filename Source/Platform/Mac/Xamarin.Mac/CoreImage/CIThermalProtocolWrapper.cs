...
internal sealed class CIThermalProtocolWrapper : BaseWrapper, ICIThermalProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIThermalProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
