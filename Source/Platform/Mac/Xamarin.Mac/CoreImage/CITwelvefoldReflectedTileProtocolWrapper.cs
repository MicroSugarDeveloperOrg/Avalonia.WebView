...
internal sealed class CITwelvefoldReflectedTileProtocolWrapper : BaseWrapper, ICITwelvefoldReflectedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CITwelvefoldReflectedTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
