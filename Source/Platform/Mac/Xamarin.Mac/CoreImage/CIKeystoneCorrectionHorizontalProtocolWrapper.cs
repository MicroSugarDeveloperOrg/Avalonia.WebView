...
internal sealed class CIKeystoneCorrectionHorizontalProtocolWrapper : BaseWrapper, ICIKeystoneCorrectionHorizontalProtocol, INativeObject, IDisposable, ICIFilterProtocol, ICIFourCoordinateGeometryFilterProtocol
{
	...
	public CIKeystoneCorrectionHorizontalProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
