...
internal sealed class CIPerspectiveTransformWithExtentProtocolWrapper : BaseWrapper, ICIPerspectiveTransformWithExtentProtocol, INativeObject, IDisposable, ICIFilterProtocol, ICIFourCoordinateGeometryFilterProtocol
{
	...
	public CIPerspectiveTransformWithExtentProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
