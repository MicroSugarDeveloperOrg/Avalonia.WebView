...
public class CISixfoldRotatedTile : CITileFilter, ICISixfoldRotatedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CISixfoldRotatedTile(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CISixfoldRotatedTile(NSCoder coder)
