...
internal sealed class CISixfoldRotatedTileProtocolWrapper : BaseWrapper, ICISixfoldRotatedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CISixfoldRotatedTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
