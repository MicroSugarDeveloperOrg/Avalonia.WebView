...
internal sealed class CIParallelogramTileProtocolWrapper : BaseWrapper, ICIParallelogramTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIParallelogramTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
