...
internal sealed class CISaliencyMapProtocolWrapper : BaseWrapper, ICISaliencyMapProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CISaliencyMapProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
