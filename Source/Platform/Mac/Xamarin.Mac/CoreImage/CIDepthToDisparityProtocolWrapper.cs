...
internal sealed class CIDepthToDisparityProtocolWrapper : BaseWrapper, ICIDepthToDisparityProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIDepthToDisparityProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
