...
internal sealed class CIAffineClampProtocolWrapper : BaseWrapper, ICIAffineClampProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIAffineClampProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
