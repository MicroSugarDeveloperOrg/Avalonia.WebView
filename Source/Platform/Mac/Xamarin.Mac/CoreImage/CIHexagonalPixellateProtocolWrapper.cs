...
internal sealed class CIHexagonalPixellateProtocolWrapper : BaseWrapper, ICIHexagonalPixellateProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIHexagonalPixellateProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
