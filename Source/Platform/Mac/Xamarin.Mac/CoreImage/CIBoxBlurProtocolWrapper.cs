...
internal sealed class CIBoxBlurProtocolWrapper : BaseWrapper, ICIBoxBlurProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIBoxBlurProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
