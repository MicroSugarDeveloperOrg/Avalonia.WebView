...
internal sealed class CIMaskToAlphaProtocolWrapper : BaseWrapper, ICIMaskToAlphaProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIMaskToAlphaProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
