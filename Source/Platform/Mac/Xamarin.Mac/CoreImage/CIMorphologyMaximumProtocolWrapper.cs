...
internal sealed class CIMorphologyMaximumProtocolWrapper : BaseWrapper, ICIMorphologyMaximumProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIMorphologyMaximumProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
