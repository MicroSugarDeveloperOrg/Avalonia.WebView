...
internal sealed class CIMedianProtocolWrapper : BaseWrapper, ICIMedianProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIMedianProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
