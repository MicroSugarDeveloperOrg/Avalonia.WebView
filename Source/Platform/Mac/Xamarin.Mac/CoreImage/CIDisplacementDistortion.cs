...
public class CIDisplacementDistortion : CIFilter
{
	...
	protected CIDisplacementDistortion(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIDisplacementDistortion(NSCoder coder)
