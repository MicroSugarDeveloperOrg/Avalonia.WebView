...
internal sealed class CIOpTileProtocolWrapper : BaseWrapper, ICIOpTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIOpTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
