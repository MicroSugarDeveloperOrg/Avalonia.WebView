...
public class CILineScreen : CIScreenFilter, ICILineScreenProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CILineScreen(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CILineScreen(NSCoder coder)
