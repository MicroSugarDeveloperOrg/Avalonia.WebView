...
internal sealed class CIMorphologyGradientProtocolWrapper : BaseWrapper, ICIMorphologyGradientProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIMorphologyGradientProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
