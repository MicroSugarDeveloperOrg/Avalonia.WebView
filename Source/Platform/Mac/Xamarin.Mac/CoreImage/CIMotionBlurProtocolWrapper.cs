...
internal sealed class CIMotionBlurProtocolWrapper : BaseWrapper, ICIMotionBlurProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIMotionBlurProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
