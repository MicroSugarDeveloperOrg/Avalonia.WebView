...
public class CIOpTile : CITileFilter, ICIOpTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIOpTile(NSObjectFlag t)
		: base(t)
	{
	}
