...
internal sealed class CIDisparityToDepthProtocolWrapper : BaseWrapper, ICIDisparityToDepthProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIDisparityToDepthProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
