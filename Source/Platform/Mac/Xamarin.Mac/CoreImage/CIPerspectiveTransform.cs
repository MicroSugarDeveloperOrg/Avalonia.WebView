...
public class CIPerspectiveTransform : CIFilter, ICIPerspectiveTransformProtocol, INativeObject, IDisposable, ICIFilterProtocol, ICIFourCoordinateGeometryFilterProtocol
{
	...
	protected CIPerspectiveTransform(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIPerspectiveTransform(NSCoder coder)
