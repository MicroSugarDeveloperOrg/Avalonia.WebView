...
internal sealed class CIDiscBlurProtocolWrapper : BaseWrapper, ICIDiscBlurProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIDiscBlurProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
