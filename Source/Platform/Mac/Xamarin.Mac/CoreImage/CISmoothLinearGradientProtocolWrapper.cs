...
internal sealed class CISmoothLinearGradientProtocolWrapper : BaseWrapper, ICISmoothLinearGradientProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CISmoothLinearGradientProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
