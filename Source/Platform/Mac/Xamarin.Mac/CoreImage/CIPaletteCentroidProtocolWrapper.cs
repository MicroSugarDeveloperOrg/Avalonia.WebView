...
internal sealed class CIPaletteCentroidProtocolWrapper : BaseWrapper, ICIPaletteCentroidProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIPaletteCentroidProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
