...
internal sealed class CIPerspectiveTileProtocolWrapper : BaseWrapper, ICIPerspectiveTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIPerspectiveTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
