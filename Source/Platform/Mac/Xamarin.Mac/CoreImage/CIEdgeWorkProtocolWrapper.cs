...
internal sealed class CIEdgeWorkProtocolWrapper : BaseWrapper, ICIEdgeWorkProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIEdgeWorkProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
