...
public class CICircularScreen : CIScreenFilter, ICICircularScreenProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CICircularScreen(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CICircularScreen(NSCoder coder)
