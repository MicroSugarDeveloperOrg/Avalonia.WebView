...
internal sealed class CIPointillizeProtocolWrapper : BaseWrapper, ICIPointillizeProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIPointillizeProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
