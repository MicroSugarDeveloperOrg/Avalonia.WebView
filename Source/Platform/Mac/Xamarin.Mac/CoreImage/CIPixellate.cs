...
public class CIPixellate : CIFilter, ICIPixellateProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIPixellate(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIPixellate(NSCoder coder)
