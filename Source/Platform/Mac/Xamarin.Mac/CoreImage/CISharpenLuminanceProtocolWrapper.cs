...
internal sealed class CISharpenLuminanceProtocolWrapper : BaseWrapper, ICISharpenLuminanceProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CISharpenLuminanceProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
