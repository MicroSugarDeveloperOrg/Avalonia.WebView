...
internal sealed class CITriangleTileProtocolWrapper : BaseWrapper, ICITriangleTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CITriangleTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
