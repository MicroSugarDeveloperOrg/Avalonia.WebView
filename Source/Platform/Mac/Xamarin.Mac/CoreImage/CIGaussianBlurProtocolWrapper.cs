...
internal sealed class CIGaussianBlurProtocolWrapper : BaseWrapper, ICIGaussianBlurProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIGaussianBlurProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
