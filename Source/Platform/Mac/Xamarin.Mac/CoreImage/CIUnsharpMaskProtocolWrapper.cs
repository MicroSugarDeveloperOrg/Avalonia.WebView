...
internal sealed class CIUnsharpMaskProtocolWrapper : BaseWrapper, ICIUnsharpMaskProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIUnsharpMaskProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
