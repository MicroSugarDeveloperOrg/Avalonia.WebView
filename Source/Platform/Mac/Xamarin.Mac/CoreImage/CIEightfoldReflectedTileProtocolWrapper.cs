...
internal sealed class CIEightfoldReflectedTileProtocolWrapper : BaseWrapper, ICIEightfoldReflectedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIEightfoldReflectedTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
