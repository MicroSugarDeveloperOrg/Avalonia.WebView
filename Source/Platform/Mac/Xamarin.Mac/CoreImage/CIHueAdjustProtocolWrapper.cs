...
internal sealed class CIHueAdjustProtocolWrapper : BaseWrapper, ICIHueAdjustProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIHueAdjustProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
