...
internal sealed class CIMixProtocolWrapper : BaseWrapper, ICIMixProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIMixProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
