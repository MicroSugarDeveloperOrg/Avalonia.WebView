...
internal sealed class CIFourfoldReflectedTileProtocolWrapper : BaseWrapper, ICIFourfoldReflectedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIFourfoldReflectedTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
