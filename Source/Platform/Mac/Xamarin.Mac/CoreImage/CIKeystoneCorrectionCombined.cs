...
public class CIKeystoneCorrectionCombined : CIKeystoneCorrection, ICIKeystoneCorrectionCombinedProtocol, INativeObject, IDisposable, ICIFilterProtocol, ICIFourCoordinateGeometryFilterProtocol
{
	...
	public CIKeystoneCorrectionCombined()
		: base("CIKeystoneCorrectionCombined")
	{
	}
	...
	protected CIKeystoneCorrectionCombined(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIKeystoneCorrectionCombined(NSCoder coder)
