...
public class CIFourfoldReflectedTile : CITileFilter, ICIFourfoldReflectedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIFourfoldReflectedTile(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIFourfoldReflectedTile(NSCoder coder)
