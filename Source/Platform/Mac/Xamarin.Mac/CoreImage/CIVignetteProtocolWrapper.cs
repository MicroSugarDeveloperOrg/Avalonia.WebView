...
internal sealed class CIVignetteProtocolWrapper : BaseWrapper, ICIVignetteProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIVignetteProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
