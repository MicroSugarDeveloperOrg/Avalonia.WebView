...
internal sealed class CIPerspectiveTransformProtocolWrapper : BaseWrapper, ICIPerspectiveTransformProtocol, INativeObject, IDisposable, ICIFilterProtocol, ICIFourCoordinateGeometryFilterProtocol
{
	...
	public CIPerspectiveTransformProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
