...
public class CIZoomBlur : CIFilter, ICIZoomBlurProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIZoomBlur(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIZoomBlur(NSCoder coder)
