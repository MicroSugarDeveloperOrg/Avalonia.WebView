...
internal sealed class CIDotScreenProtocolWrapper : BaseWrapper, ICIDotScreenProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIDotScreenProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
