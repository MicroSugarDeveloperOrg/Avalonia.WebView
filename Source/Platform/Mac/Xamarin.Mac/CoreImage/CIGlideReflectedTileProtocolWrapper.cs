...
internal sealed class CIGlideReflectedTileProtocolWrapper : BaseWrapper, ICIGlideReflectedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIGlideReflectedTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
