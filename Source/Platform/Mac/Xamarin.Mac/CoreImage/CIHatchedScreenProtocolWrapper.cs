...
internal sealed class CIHatchedScreenProtocolWrapper : BaseWrapper, ICIHatchedScreenProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIHatchedScreenProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
