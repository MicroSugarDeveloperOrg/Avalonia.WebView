...
internal sealed class CIXRayProtocolWrapper : BaseWrapper, ICIXRayProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIXRayProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
