...
public class CIPalettize : CIFilter, ICIPalettizeProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIPalettize(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIPalettize(NSCoder coder)
