...
public class CIHexagonalPixellate : CIFilter, ICIHexagonalPixellateProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIHexagonalPixellate(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIHexagonalPixellate(NSCoder coder)
