...
internal sealed class CIColorCubeProtocolWrapper : BaseWrapper, ICIColorCubeProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIColorCubeProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
