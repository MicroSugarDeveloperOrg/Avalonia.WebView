...
internal sealed class CIVignetteEffectProtocolWrapper : BaseWrapper, ICIVignetteEffectProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public float Intensity
	{
		...
		get
		{
			return Messaging.float_objc_msgSend(base.Handle, Selector.GetHandle("intensity"));
		}
		[Export("setIntensity:")]
		set
		{
			Messaging.void_objc_msgSend_float(base.Handle, Selector.GetHandle("setIntensity:"), value);
		}
	}
	...
	public float Falloff
	{
		...
		get
		{
			return Messaging.float_objc_msgSend(base.Handle, Selector.GetHandle("falloff"));
		}
		[Export("setFalloff:")]
		set
		{
			Messaging.void_objc_msgSend_float(base.Handle, Selector.GetHandle("setFalloff:"), value);
		}
	}
	...
	public CIVignetteEffectProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
