...
internal sealed class CIGaborGradientsProtocolWrapper : BaseWrapper, ICIGaborGradientsProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIGaborGradientsProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
