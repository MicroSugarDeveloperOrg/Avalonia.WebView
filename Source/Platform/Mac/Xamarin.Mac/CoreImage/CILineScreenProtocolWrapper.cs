...
internal sealed class CILineScreenProtocolWrapper : BaseWrapper, ICILineScreenProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CILineScreenProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
