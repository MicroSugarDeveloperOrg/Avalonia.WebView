...
internal sealed class CILinearToSrgbToneCurveProtocolWrapper : BaseWrapper, ICILinearToSrgbToneCurveProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CILinearToSrgbToneCurveProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
