...
internal sealed class CIMinimumComponentProtocolWrapper : BaseWrapper, ICIMinimumComponentProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIMinimumComponentProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
