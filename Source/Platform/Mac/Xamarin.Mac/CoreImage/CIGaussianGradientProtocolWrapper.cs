...
internal sealed class CIGaussianGradientProtocolWrapper : BaseWrapper, ICIGaussianGradientProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIGaussianGradientProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
