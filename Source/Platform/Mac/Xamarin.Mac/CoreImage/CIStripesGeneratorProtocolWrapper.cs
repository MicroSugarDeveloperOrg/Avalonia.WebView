...
internal sealed class CIStripesGeneratorProtocolWrapper : BaseWrapper, ICIStripesGeneratorProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIStripesGeneratorProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
