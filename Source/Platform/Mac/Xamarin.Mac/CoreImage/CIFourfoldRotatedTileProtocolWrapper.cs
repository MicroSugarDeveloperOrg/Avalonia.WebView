...
internal sealed class CIFourfoldRotatedTileProtocolWrapper : BaseWrapper, ICIFourfoldRotatedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIFourfoldRotatedTileProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
