...
internal sealed class CIHeightFieldFromMaskProtocolWrapper : BaseWrapper, ICIHeightFieldFromMaskProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	public CIHeightFieldFromMaskProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
}
