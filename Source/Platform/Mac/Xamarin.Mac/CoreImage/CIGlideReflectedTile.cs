...
public class CIGlideReflectedTile : CITileFilter, ICIGlideReflectedTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIGlideReflectedTile(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIGlideReflectedTile(NSCoder coder)
