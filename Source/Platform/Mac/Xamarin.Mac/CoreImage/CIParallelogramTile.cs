...
public class CIParallelogramTile : CITileFilter, ICIParallelogramTileProtocol, INativeObject, IDisposable, ICIFilterProtocol
{
	...
	protected CIParallelogramTile(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public CIParallelogramTile(NSCoder coder)
