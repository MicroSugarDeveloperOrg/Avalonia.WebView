...
public class ICScannerFunctionalUnitFlatbed : ICScannerFunctionalUnit
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("ICScannerFunctionalUnitFlatbed");
	...
	protected ICScannerFunctionalUnitFlatbed(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal ICScannerFunctionalUnitFlatbed(IntPtr handle)
		: base(handle)
	{
	}
}
