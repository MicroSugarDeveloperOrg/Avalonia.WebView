...
[Register("ICScannerFunctionalUnitNegativeTransparency", true)]
public class ICScannerFunctionalUnitNegativeTransparency : ICScannerFunctionalUnit
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("ICScannerFunctionalUnitNegativeTransparency");
	...
	protected ICScannerFunctionalUnitNegativeTransparency(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal ICScannerFunctionalUnitNegativeTransparency(IntPtr handle)
		: base(handle)
	{
	}
}
