...
public class AVAudioMixingDestination : NSObject, IAVAudio3DMixing, INativeObject, IDisposable, IAVAudioMixing, IAVAudioStereoMixing
{
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selConnectionPoint = "connectionPoint";

	private static readonly IntPtr selConnectionPointHandle = Selector.GetHandle("connectionPoint");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("AVAudioMixingDestination");
	...
	public virtual AVAudioConnectionPoint ConnectionPoint
	{
		...
		get
		{
			...
			{
				return Runtime.GetNSObject<AVAudioConnectionPoint>(Messaging.IntPtr_objc_msgSend(base.Handle, selConnectionPointHandle));
			}
			return Runtime.GetNSObject<AVAudioConnectionPoint>(Messaging.IntPtr_objc_msgSendSuper(base.SuperHandle, selConnectionPointHandle));
		}
	}
	...
	protected AVAudioMixingDestination(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal AVAudioMixingDestination(IntPtr handle)
		: base(handle)
	{
	}
