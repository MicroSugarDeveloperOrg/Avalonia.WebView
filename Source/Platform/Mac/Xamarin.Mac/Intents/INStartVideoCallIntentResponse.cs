...
public class INStartVideoCallIntentResponse : INIntentResponse
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("INStartVideoCallIntentResponse");
	...
	public virtual INStartVideoCallIntentResponseCode Code
	{
		...
		get
		{
			...
			{
				return (INStartVideoCallIntentResponseCode)Messaging.Int64_objc_msgSend(base.Handle, selCodeHandle);
			}
			return (INStartVideoCallIntentResponseCode)Messaging.Int64_objc_msgSendSuper(base.SuperHandle, selCodeHandle);
		}
	}
	...
	public INStartVideoCallIntentResponse(NSCoder coder)
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected INStartVideoCallIntentResponse(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal INStartVideoCallIntentResponse(IntPtr handle)
		: base(handle)
	{
	}
