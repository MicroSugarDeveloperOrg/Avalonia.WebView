...
public class MPSCnnBinaryFullyConnectedNode : MPSCnnBinaryConvolutionNode
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSCNNBinaryFullyConnectedNode");
	...
	[Mac(10, 13, 4)]
	[iOS(11, 3)]
	public new unsafe static MPSCnnBinaryFullyConnectedNode Create(MPSNNImageNode sourceNode, IMPSCnnConvolutionDataSource weights, float[] outputBiasTerms, float[] outputScaleTerms, float[] inputBiasTerms, float[] inputScaleTerms, MPSCnnBinaryConvolutionType type, MPSCnnBinaryConvolutionFlags flags)
	{
	...
	[Mac(10, 13, 4)]
	[iOS(11, 3)]
	public unsafe MPSCnnBinaryFullyConnectedNode(MPSNNImageNode sourceNode, IMPSCnnConvolutionDataSource weights, float[] outputBiasTerms, float[] outputScaleTerms, float[] inputBiasTerms, float[] inputScaleTerms, MPSCnnBinaryConvolutionType type, MPSCnnBinaryConvolutionFlags flags)
	...
	protected MPSCnnBinaryFullyConnectedNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MPSCnnBinaryFullyConnectedNode(IntPtr handle)
		: base(handle)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public new static MPSCnnBinaryFullyConnectedNode Create(MPSNNImageNode sourceNode, IMPSCnnConvolutionDataSource weights, float scaleValue, MPSCnnBinaryConvolutionType type, MPSCnnBinaryConvolutionFlags flags)
	{
		if (sourceNode == null)
		{
			throw new ArgumentNullException("sourceNode");
		...
		return Runtime.GetNSObject<MPSCnnBinaryFullyConnectedNode>(Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_float_UInt64_UInt64(class_ptr, selNodeWithSource_Weights_ScaleValue_Type_Flags_Handle, sourceNode.Handle, weights.Handle, scaleValue, (ulong)type, (ulong)flags));
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	internal new static MPSCnnBinaryFullyConnectedNode Create(MPSNNImageNode sourceNode, IMPSCnnConvolutionDataSource weights, IntPtr outputBiasTerms, IntPtr outputScaleTerms, IntPtr inputBiasTerms, IntPtr inputScaleTerms, MPSCnnBinaryConvolutionType type, MPSCnnBinaryConvolutionFlags flags)
	{
		if (sourceNode == null)
		{
			throw new ArgumentNullException("sourceNode");
	...
	[Introduced(PlatformName.iOS, 11, 3, PlatformArchitecture.All, null)]
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	internal new virtual IntPtr InitWithSource(MPSNNImageNode sourceNode, IMPSCnnConvolutionDataSource weights, IntPtr outputBiasTerms, IntPtr outputScaleTerms, IntPtr inputBiasTerms, IntPtr inputScaleTerms, MPSCnnBinaryConvolutionType type, MPSCnnBinaryConvolutionFlags flags)
	{
		if (sourceNode == null)
		{
			throw new ArgumentNullException("sourceNode");
