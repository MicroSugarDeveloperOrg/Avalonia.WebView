...
public class MPSNNReductionFeatureChannelsArgumentMaxNode : MPSNNUnaryReductionNode
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSNNReductionFeatureChannelsArgumentMaxNode");

	public override IntPtr ClassHandle => class_ptr;

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSNNReductionFeatureChannelsArgumentMaxNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MPSNNReductionFeatureChannelsArgumentMaxNode(IntPtr handle)
		: base(handle)
	{
	}
	...
	public new static MPSNNReductionFeatureChannelsArgumentMaxNode Create(MPSNNImageNode sourceNode)
	{
		...
		return Runtime.GetNSObject<MPSNNReductionFeatureChannelsArgumentMaxNode>(Messaging.IntPtr_objc_msgSend_IntPtr(class_ptr, selNodeWithSource_Handle, sourceNode.Handle));
	}
}
