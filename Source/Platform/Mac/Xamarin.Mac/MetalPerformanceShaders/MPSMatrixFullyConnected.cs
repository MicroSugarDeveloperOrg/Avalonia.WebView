...
public class MPSMatrixFullyConnected : MPSMatrixBinaryKernel
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selEncodeToCommandBuffer_InputMatrix_WeightMatrix_BiasVector_ResultMatrix_ = "encodeToCommandBuffer:inputMatrix:weightMatrix:biasVector:resultMatrix:";

	private static readonly IntPtr selEncodeToCommandBuffer_InputMatrix_WeightMatrix_BiasVector_ResultMatrix_Handle = Selector.GetHandle("encodeToCommandBuffer:inputMatrix:weightMatrix:biasVector:resultMatrix:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSMatrixFullyConnected");
	...
	public MPSMatrixFullyConnected(NSCoder coder)
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSMatrixFullyConnected(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MPSMatrixFullyConnected(IntPtr handle)
		: base(handle)
	{
	}
	...
	[DesignatedInitializer]
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSMatrixFullyConnected(IMTLDevice device)
		: base(NSObjectFlag.Empty)
	{
		if (device == null)
		{
	...
	[DesignatedInitializer]
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSMatrixFullyConnected(NSCoder aDecoder, IMTLDevice device)
		: base(NSObjectFlag.Empty)
	{
		if (aDecoder == null)
		{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[return: Release]
	public virtual MPSMatrixFullyConnected Copy(NSZone? zone, IMTLDevice? device)
	{
		MPSMatrixFullyConnected mPSMatrixFullyConnected = ((!base.IsDirectBinding) ? Runtime.GetNSObject<MPSMatrixFullyConnected>(Messaging.IntPtr_objc_msgSendSuper_IntPtr_IntPtr(base.SuperHandle, selCopyWithZone_Device_Handle, zone?.Handle ?? IntPtr.Zero, device?.Handle ?? IntPtr.Zero)) : Runtime.GetNSObject<MPSMatrixFullyConnected>(Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr(base.Handle, selCopyWithZone_Device_Handle, zone?.Handle ?? IntPtr.Zero, device?.Handle ?? IntPtr.Zero)));
		if (mPSMatrixFullyConnected != null)
		{
			Messaging.void_objc_msgSend(mPSMatrixFullyConnected.Handle, Selector.GetHandle("release"));
		}
		return mPSMatrixFullyConnected;
	}

	[Export("encodeToCommandBuffer:inputMatrix:weightMatrix:biasVector:resultMatrix:")]
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public virtual void EncodeToCommandBuffer(IMTLCommandBuffer commandBuffer, MPSMatrix inputMatrix, MPSMatrix weightMatrix, MPSVector? biasVector, MPSMatrix resultMatrix)
	{
		...
		if (base.IsDirectBinding)
		{
			Messaging.void_objc_msgSend_IntPtr_IntPtr_IntPtr_IntPtr_IntPtr(base.Handle, selEncodeToCommandBuffer_InputMatrix_WeightMatrix_BiasVector_ResultMatrix_Handle, commandBuffer.Handle, inputMatrix.Handle, weightMatrix.Handle, biasVector?.Handle ?? IntPtr.Zero, resultMatrix.Handle);
		}
		else
		{
			Messaging.void_objc_msgSendSuper_IntPtr_IntPtr_IntPtr_IntPtr_IntPtr(base.SuperHandle, selEncodeToCommandBuffer_InputMatrix_WeightMatrix_BiasVector_ResultMatrix_Handle, commandBuffer.Handle, inputMatrix.Handle, weightMatrix.Handle, biasVector?.Handle ?? IntPtr.Zero, resultMatrix.Handle);
		}
	}
