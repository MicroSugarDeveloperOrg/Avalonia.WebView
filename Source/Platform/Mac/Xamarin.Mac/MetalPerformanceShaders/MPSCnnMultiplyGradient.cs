...
public class MPSCnnMultiplyGradient : MPSCnnArithmeticGradient
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSCNNMultiplyGradient");
	...
	public MPSCnnMultiplyGradient(NSCoder coder)
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSCnnMultiplyGradient(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[DesignatedInitializer]
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSCnnMultiplyGradient(IMTLDevice device, bool isSecondarySourceFilter)
		: base(NSObjectFlag.Empty)
	{
		if (device == null)
		{
