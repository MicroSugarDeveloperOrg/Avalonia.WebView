...
public class MPSCnnInstanceNormalizationGradientNode : MPSNNGradientFilterNode, IMPSNNTrainableNode, INativeObject, IDisposable
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSCNNInstanceNormalizationGradientNode");
	...
	protected MPSCnnInstanceNormalizationGradientNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MPSCnnInstanceNormalizationGradientNode(IntPtr handle)
		: base(handle)
	{
	}
	...
	public static MPSCnnInstanceNormalizationGradientNode Create(MPSNNImageNode sourceGradient, MPSNNImageNode sourceImage, MPSNNGradientStateNode gradientState)
	{
		...
		return Runtime.GetNSObject<MPSCnnInstanceNormalizationGradientNode>(Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_IntPtr(class_ptr, selNodeWithSourceGradient_SourceImage_GradientState_Handle, sourceGradient.Handle, sourceImage.Handle, gradientState.Handle));
	}
}
