...
public class MPSNNReductionColumnMinNode : MPSNNUnaryReductionNode
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSNNReductionColumnMinNode");

	public override IntPtr ClassHandle => class_ptr;

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSNNReductionColumnMinNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public new static MPSNNReductionColumnMinNode Create(MPSNNImageNode sourceNode)
	{
		...
		return Runtime.GetNSObject<MPSNNReductionColumnMinNode>(Messaging.IntPtr_objc_msgSend_IntPtr(class_ptr, selNodeWithSource_Handle, sourceNode.Handle));
	}
}
