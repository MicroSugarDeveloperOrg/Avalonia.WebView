...
public class MPSImageDilate : MPSUnaryImageKernel
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selInitWithDevice_KernelWidth_KernelHeight_Values_ = "initWithDevice:kernelWidth:kernelHeight:values:";

	private static readonly IntPtr selInitWithDevice_KernelWidth_KernelHeight_Values_Handle = Selector.GetHandle("initWithDevice:kernelWidth:kernelHeight:values:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSImageDilate");
	...
	public unsafe MPSImageDilate(IMTLDevice device, nuint kernelWidth, nuint kernelHeight, float[] values)
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSImageDilate(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MPSImageDilate(IntPtr handle)
		: base(handle)
	{
	}
	...
	[DesignatedInitializer]
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSImageDilate(NSCoder aDecoder, IMTLDevice device)
		: base(NSObjectFlag.Empty)
	{
		if (aDecoder == null)
		{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	internal virtual IntPtr InitWithDevice(IMTLDevice device, nuint kernelWidth, nuint kernelHeight, IntPtr values)
	{
		if (device == null)
		{
			throw new ArgumentNullException("device");
		...
		if (base.IsDirectBinding)
		{
			return Messaging.IntPtr_objc_msgSend_IntPtr_nuint_nuint_IntPtr(base.Handle, selInitWithDevice_KernelWidth_KernelHeight_Values_Handle, device.Handle, kernelWidth, kernelHeight, values);
		}
		return Messaging.IntPtr_objc_msgSendSuper_IntPtr_nuint_nuint_IntPtr(base.SuperHandle, selInitWithDevice_KernelWidth_KernelHeight_Values_Handle, device.Handle, kernelWidth, kernelHeight, values);
	}
}
