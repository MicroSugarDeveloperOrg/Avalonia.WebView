...
public class MPSCnnUpsamplingNearestGradientNode : MPSNNGradientFilterNode
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSCNNUpsamplingNearestGradientNode");
	...
	protected MPSCnnUpsamplingNearestGradientNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public static MPSCnnUpsamplingNearestGradientNode Create(MPSNNImageNode sourceGradient, MPSNNImageNode sourceImage, MPSNNGradientStateNode gradientState, double scaleFactorX, double scaleFactorY)
	{
		...
		return Runtime.GetNSObject<MPSCnnUpsamplingNearestGradientNode>(Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_IntPtr_Double_Double(class_ptr, selNodeWithSourceGradient_SourceImage_GradientState_ScaleFactorX_ScaleFactorY_Handle, sourceGradient.Handle, sourceImage.Handle, gradientState.Handle, scaleFactorX, scaleFactorY));
	}
}
