...
public class MPSNNSubtractionGradientNode : MPSNNArithmeticGradientNode
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSNNSubtractionGradientNode");

	public override IntPtr ClassHandle => class_ptr;

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSNNSubtractionGradientNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MPSNNSubtractionGradientNode(IntPtr handle)
		: base(handle)
	{
	}
	...
	public new static MPSNNSubtractionGradientNode Create(MPSNNImageNode sourceGradient, MPSNNImageNode sourceImage, MPSNNBinaryGradientStateNode gradientState, bool isSecondarySourceFilter)
	{
		...
		return Runtime.GetNSObject<MPSNNSubtractionGradientNode>(Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_IntPtr_bool(class_ptr, selNodeWithSourceGradient_SourceImage_GradientState_IsSecondarySourceFilter_Handle, sourceGradient.Handle, sourceImage.Handle, gradientState.Handle, isSecondarySourceFilter));
	}
}
