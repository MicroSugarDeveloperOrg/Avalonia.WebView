...
public class MPSNNReduceFeatureChannelsMean : MPSNNReduceUnary
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSNNReduceFeatureChannelsMean");
	...
	public MPSNNReduceFeatureChannelsMean(NSCoder coder)
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSNNReduceFeatureChannelsMean(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[DesignatedInitializer]
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSNNReduceFeatureChannelsMean(IMTLDevice device)
		: base(NSObjectFlag.Empty)
	{
		if (device == null)
		{
