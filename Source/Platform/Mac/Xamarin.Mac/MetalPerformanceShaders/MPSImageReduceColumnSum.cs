...
public class MPSImageReduceColumnSum : MPSImageReduceUnary
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSImageReduceColumnSum");
	...
	public MPSImageReduceColumnSum(NSCoder coder)
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSImageReduceColumnSum(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[DesignatedInitializer]
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSImageReduceColumnSum(IMTLDevice device)
		: base(NSObjectFlag.Empty)
	{
		if (device == null)
		{
