...
public class MPSCnnNeuronPowerNode : MPSCnnNeuronNode
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSCNNNeuronPowerNode");

	public override IntPtr ClassHandle => class_ptr;

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSCnnNeuronPowerNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public static MPSCnnNeuronPowerNode Create(MPSNNImageNode sourceNode, float a, float b, float c)
	{
		...
		return Runtime.GetNSObject<MPSCnnNeuronPowerNode>(Messaging.IntPtr_objc_msgSend_IntPtr_float_float_float(class_ptr, selNodeWithSource_A_B_C_Handle, sourceNode.Handle, a, b, c));
	}
	...
	public static MPSCnnNeuronPowerNode Create(MPSNNImageNode sourceNode)
	{
		...
		return Runtime.GetNSObject<MPSCnnNeuronPowerNode>(Messaging.IntPtr_objc_msgSend_IntPtr(class_ptr, selNodeWithSource_Handle, sourceNode.Handle));
	}
}
