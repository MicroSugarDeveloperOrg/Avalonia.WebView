...
public class MPSImageReduceColumnMax : MPSImageReduceUnary
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSImageReduceColumnMax");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSImageReduceColumnMax(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[DesignatedInitializer]
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSImageReduceColumnMax(IMTLDevice device)
		: base(NSObjectFlag.Empty)
	{
		if (device == null)
		{
