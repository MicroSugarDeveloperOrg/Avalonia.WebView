...
public class MPSNNAdditionGradientNode : MPSNNArithmeticGradientNode
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSNNAdditionGradientNode");

	public override IntPtr ClassHandle => class_ptr;

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSNNAdditionGradientNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public new static MPSNNAdditionGradientNode Create(MPSNNImageNode sourceGradient, MPSNNImageNode sourceImage, MPSNNBinaryGradientStateNode gradientState, bool isSecondarySourceFilter)
	{
		...
		return Runtime.GetNSObject<MPSNNAdditionGradientNode>(Messaging.IntPtr_objc_msgSend_IntPtr_IntPtr_IntPtr_bool(class_ptr, selNodeWithSourceGradient_SourceImage_GradientState_IsSecondarySourceFilter_Handle, sourceGradient.Handle, sourceImage.Handle, gradientState.Handle, isSecondarySourceFilter));
	}
}
