...
public class MPSNNReduceFeatureChannelsMin : MPSNNReduceUnary
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSNNReduceFeatureChannelsMin");
	...
	public MPSNNReduceFeatureChannelsMin(NSCoder coder)
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSNNReduceFeatureChannelsMin(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[DesignatedInitializer]
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSNNReduceFeatureChannelsMin(IMTLDevice device)
		: base(NSObjectFlag.Empty)
	{
		if (device == null)
		{
