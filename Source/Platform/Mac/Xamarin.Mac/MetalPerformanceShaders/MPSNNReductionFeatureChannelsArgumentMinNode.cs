...
public class MPSNNReductionFeatureChannelsArgumentMinNode : MPSNNUnaryReductionNode
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSNNReductionFeatureChannelsArgumentMinNode");

	public override IntPtr ClassHandle => class_ptr;

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSNNReductionFeatureChannelsArgumentMinNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MPSNNReductionFeatureChannelsArgumentMinNode(IntPtr handle)
		: base(handle)
	{
	}
	...
	public new static MPSNNReductionFeatureChannelsArgumentMinNode Create(MPSNNImageNode sourceNode)
	{
		...
		return Runtime.GetNSObject<MPSNNReductionFeatureChannelsArgumentMinNode>(Messaging.IntPtr_objc_msgSend_IntPtr(class_ptr, selNodeWithSource_Handle, sourceNode.Handle));
	}
}
