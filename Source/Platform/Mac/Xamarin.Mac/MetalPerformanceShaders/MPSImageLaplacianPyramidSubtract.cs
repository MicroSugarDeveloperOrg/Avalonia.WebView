...
public class MPSImageLaplacianPyramidSubtract : MPSImageLaplacianPyramid
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSImageLaplacianPyramidSubtract");

	public override IntPtr ClassHandle => class_ptr;

	[DesignatedInitializer]
	public unsafe MPSImageLaplacianPyramidSubtract(IMTLDevice device, nuint kernelWidth, nuint kernelHeight, float[] kernelWeights)
	...
	public MPSImageLaplacianPyramidSubtract(NSCoder coder)
		: base(NSObjectFlag.Empty)
	{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSImageLaplacianPyramidSubtract(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSImageLaplacianPyramidSubtract(NSCoder aDecoder, IMTLDevice device)
		: base(NSObjectFlag.Empty)
	{
		if (aDecoder == null)
		{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSImageLaplacianPyramidSubtract(IMTLDevice device)
		: base(NSObjectFlag.Empty)
	{
		if (device == null)
		{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	public MPSImageLaplacianPyramidSubtract(IMTLDevice device, float centerWeight)
		: base(NSObjectFlag.Empty)
	{
		if (device == null)
		{
