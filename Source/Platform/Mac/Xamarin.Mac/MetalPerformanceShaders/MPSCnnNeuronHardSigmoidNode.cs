...
public class MPSCnnNeuronHardSigmoidNode : MPSCnnNeuronNode
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSCNNNeuronHardSigmoidNode");

	public override IntPtr ClassHandle => class_ptr;

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSCnnNeuronHardSigmoidNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal MPSCnnNeuronHardSigmoidNode(IntPtr handle)
		: base(handle)
	{
	}
	...
	public static MPSCnnNeuronHardSigmoidNode Create(MPSNNImageNode sourceNode, float a, float b)
	{
		...
		return Runtime.GetNSObject<MPSCnnNeuronHardSigmoidNode>(Messaging.IntPtr_objc_msgSend_IntPtr_float_float(class_ptr, selNodeWithSource_A_B_Handle, sourceNode.Handle, a, b));
	}
	...
	public static MPSCnnNeuronHardSigmoidNode Create(MPSNNImageNode sourceNode)
	{
		...
		return Runtime.GetNSObject<MPSCnnNeuronHardSigmoidNode>(Messaging.IntPtr_objc_msgSend_IntPtr(class_ptr, selNodeWithSource_Handle, sourceNode.Handle));
	}
}
