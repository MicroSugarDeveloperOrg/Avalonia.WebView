...
public class MPSNNReductionColumnMaxNode : MPSNNUnaryReductionNode
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("MPSNNReductionColumnMaxNode");

	public override IntPtr ClassHandle => class_ptr;

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected MPSNNReductionColumnMaxNode(NSObjectFlag t)
		: base(t)
	{
	}
	...
	public new static MPSNNReductionColumnMaxNode Create(MPSNNImageNode sourceNode)
	{
		...
		return Runtime.GetNSObject<MPSNNReductionColumnMaxNode>(Messaging.IntPtr_objc_msgSend_IntPtr(class_ptr, selNodeWithSource_Handle, sourceNode.Handle));
	}
}
