...
internal sealed class NSObjectProtocolWrapper : BaseWrapper, INSObjectProtocol, INativeObject, IDisposable
{
	...
	public NSObjectProtocolWrapper(IntPtr handle, bool owns)
		: base(handle, owns)
	{
	}
