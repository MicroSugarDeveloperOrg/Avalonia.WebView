...
public class NSUnitDispersion : NSDimension, INSCoding, INativeObject, IDisposable, INSSecureCoding
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selPartsPerMillion = "partsPerMillion";

	private static readonly IntPtr selPartsPerMillionHandle = Selector.GetHandle("partsPerMillion");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("NSUnitDispersion");
	...
	public static NSUnitDispersion PartsPerMillion
	{
		...
		get
		{
			return Runtime.GetNSObject<NSUnitDispersion>(Messaging.IntPtr_objc_msgSend(class_ptr, selPartsPerMillionHandle));
		}
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal NSUnitDispersion(IntPtr handle)
		: base(handle)
	{
	}
