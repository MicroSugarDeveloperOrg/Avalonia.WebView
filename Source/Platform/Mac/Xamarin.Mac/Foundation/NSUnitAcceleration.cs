...
public class NSUnitAcceleration : NSDimension, INSCoding, INativeObject, IDisposable, INSSecureCoding
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selMetersPerSecondSquared = "metersPerSecondSquared";

	private static readonly IntPtr selMetersPerSecondSquaredHandle = Selector.GetHandle("metersPerSecondSquared");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("NSUnitAcceleration");
	...
	public static NSUnitAcceleration Gravity
	{
		...
		get
		{
			return Runtime.GetNSObject<NSUnitAcceleration>(Messaging.IntPtr_objc_msgSend(class_ptr, selGravityHandle));
		}
	}
	...
	public static NSUnitAcceleration MetersPerSecondSquared
	{
		...
		get
		{
			return Runtime.GetNSObject<NSUnitAcceleration>(Messaging.IntPtr_objc_msgSend(class_ptr, selMetersPerSecondSquaredHandle));
		}
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal NSUnitAcceleration(IntPtr handle)
		: base(handle)
	{
	}
