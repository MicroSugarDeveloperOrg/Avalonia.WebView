...
public abstract class NSDimension : NSUnit, INSCoding, INativeObject, IDisposable, INSSecureCoding
{
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selConverter = "converter";

	private static readonly IntPtr selConverterHandle = Selector.GetHandle("converter");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("NSDimension");
	...
	public virtual NSUnitConverter Converter
	{
		...
		get
		{
			...
			{
				return Runtime.GetNSObject<NSUnitConverter>(Messaging.IntPtr_objc_msgSend(base.Handle, selConverterHandle));
			}
			return Runtime.GetNSObject<NSUnitConverter>(Messaging.IntPtr_objc_msgSendSuper(base.SuperHandle, selConverterHandle));
		}
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal NSDimension(IntPtr handle)
		: base(handle)
	{
	}
