...
public class NSUnitIlluminance : NSDimension, INSCoding, INativeObject, IDisposable, INSSecureCoding
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selLux = "lux";

	private static readonly IntPtr selLuxHandle = Selector.GetHandle("lux");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("NSUnitIlluminance");
	...
	public static NSUnitIlluminance Lux
	{
		...
		get
		{
			return Runtime.GetNSObject<NSUnitIlluminance>(Messaging.IntPtr_objc_msgSend(class_ptr, selLuxHandle));
		}
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal NSUnitIlluminance(IntPtr handle)
		: base(handle)
	{
	}
