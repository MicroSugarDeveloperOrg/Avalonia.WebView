...
public class SCNLayer : CAOpenGLLayer, ISCNSceneRenderer, INativeObject, IDisposable, ISCNTechniqueSupport
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("SCNLayer");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected SCNLayer(NSObjectFlag t)
		: base(t)
	{
	}
