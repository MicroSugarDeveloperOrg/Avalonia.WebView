...
public struct BlockLiteral
{
	...
	private IntPtr block_descriptor;

	private IntPtr local_handle;

	private IntPtr global_handle;

	private static IntPtr block_class;
	...
	{
		if ((object)trampoline == null)
		{
			throw new ArgumentNullException("trampoline");
		}
	...
	public unsafe void CleanupBlock()
	{
		...
		XamarinBlockDescriptor* ptr = (XamarinBlockDescriptor*)(void*)block_descriptor;
		if (Interlocked.Decrement(ref ptr->ref_count) == 0)
		{
	...
	public unsafe static T GetTarget<T>(IntPtr block) where T : class
	{
		return (T)((BlockLiteral*)(void*)block)->Target;
	}
	...
	internal unsafe static void SimpleCall(Action callbackToInvoke, Action<IntPtr> pinvoke)
	{
		...
		blockLiteral.SetupBlockUnsafe(BlockStaticDispatchClass.static_dispatch_block, callbackToInvoke);
		try
		{
			pinvoke((IntPtr)ptr);
		}
