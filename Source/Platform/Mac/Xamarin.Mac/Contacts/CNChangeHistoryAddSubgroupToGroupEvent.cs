...
public class CNChangeHistoryAddSubgroupToGroupEvent : CNChangeHistoryEvent
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("CNChangeHistoryAddSubgroupToGroupEvent");
	...
	public CNChangeHistoryAddSubgroupToGroupEvent(NSCoder coder)
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected CNChangeHistoryAddSubgroupToGroupEvent(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal CNChangeHistoryAddSubgroupToGroupEvent(IntPtr handle)
		: base(handle)
	{
	}
}
