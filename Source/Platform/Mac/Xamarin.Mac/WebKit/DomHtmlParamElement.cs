...
public class DomHtmlParamElement : DomHtmlElement
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selSetValueType_ = "setValueType:";

	private static readonly IntPtr selSetValueType_Handle = Selector.GetHandle("setValueType:");
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private const string selValueType = "valueType";

	private static readonly IntPtr selValueTypeHandle = Selector.GetHandle("valueType");

	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("DOMHTMLParamElement");
	...
	public virtual string ValueType
	{
		...
		get
		{
			if (base.IsDirectBinding)
			{
				return NSString.FromHandle(Messaging.IntPtr_objc_msgSend(base.Handle, selValueTypeHandle));
			}
			return NSString.FromHandle(Messaging.IntPtr_objc_msgSendSuper(base.SuperHandle, selValueTypeHandle));
		}
		[Export("setValueType:")]
		set
		{
			...
			if (base.IsDirectBinding)
			{
				Messaging.void_objc_msgSend_IntPtr(base.Handle, selSetValueType_Handle, arg);
			}
			else
			{
				Messaging.void_objc_msgSendSuper_IntPtr(base.SuperHandle, selSetValueType_Handle, arg);
			}
			NSString.ReleaseNative(arg);
		}
	}
	...
	protected DomHtmlParamElement(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal DomHtmlParamElement(IntPtr handle)
		: base(handle)
	{
	}
}
