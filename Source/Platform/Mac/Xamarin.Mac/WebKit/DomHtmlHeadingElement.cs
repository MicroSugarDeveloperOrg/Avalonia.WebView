...
[Register("DOMHTMLHeadingElement", true)]
...
public class DomHtmlHeadingElement : DomHtmlElement
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("DOMHTMLHeadingElement");
	...
	protected DomHtmlHeadingElement(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal DomHtmlHeadingElement(IntPtr handle)
		: base(handle)
	{
	}
}
