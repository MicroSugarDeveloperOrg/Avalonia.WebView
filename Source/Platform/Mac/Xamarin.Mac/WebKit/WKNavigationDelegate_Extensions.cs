...
{
    public unsafe static void DecidePolicy(this IWKNavigationDelegate This, WKWebView webView, WKNavigationAction navigationAction, [BlockProxy(typeof(NSAction))] Action<WKNavigationActionPolicy> decisionHandler)
    {
        if (webView == null)
        {
    ...
    public unsafe static void DecidePolicy(this IWKNavigationDelegate This, WKWebView webView, WKNavigationResponse navigationResponse, [BlockProxy(typeof(NSAction))] Action<WKNavigationResponsePolicy> decisionHandler)
    {
        if (webView == null)
        {
            throw new ArgumentNullException("webView");
    ...
    public unsafe static void DecidePolicy(this IWKNavigationDelegate This, WKWebView webView, WKNavigationAction navigationAction, WKWebpagePreferences preferences, [BlockProxy(typeof(NSAction))] Action<WKNavigationActionPolicy, WKWebpagePreferences> decisionHandler)
    {
        if (webView == null)
        {
            throw new ArgumentNullException("webView");
    ...
    public unsafe static void DidReceiveAuthenticationChallenge(this IWKNavigationDelegate This, WKWebView webView, NSUrlAuthenticationChallenge challenge, [BlockProxy(typeof(NSAction))] Action<NSUrlSessionAuthChallengeDisposition, NSUrlCredential> completionHandler)
    {
        if (webView == null)
        {
            throw new ArgumentNullException("webView");
