...
[Register("DOMHTMLMenuElement", true)]
...
public class DomHtmlMenuElement : DomHtmlElement
{
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	private static readonly IntPtr class_ptr = ObjCRuntime.Class.GetHandle("DOMHTMLMenuElement");
	...
	protected DomHtmlMenuElement(NSObjectFlag t)
		: base(t)
	{
	}
	...
	[BindingImpl(BindingImplOptions.GeneratedCode | BindingImplOptions.Optimizable)]
	[EditorBrowsable(EditorBrowsableState.Advanced)]
	protected internal DomHtmlMenuElement(IntPtr handle)
		: base(handle)
	{
	}
}
