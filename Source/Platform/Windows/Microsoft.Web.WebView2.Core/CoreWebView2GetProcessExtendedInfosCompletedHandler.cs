...
internal class CoreWebView2GetProcessExtendedInfosCompletedHandler : ICoreWebView2GetProcessExtendedInfosCompletedHandler, INotifyCompletion
{
    ...
    public IReadOnlyList<CoreWebView2ProcessExtendedInfo> value { get; private set; }
    ...
    {
        this.value = ((value == null) ? null : COMDotNetTypeConverter.ProcessExtendedInfoCollectionCOMToNet(value));
