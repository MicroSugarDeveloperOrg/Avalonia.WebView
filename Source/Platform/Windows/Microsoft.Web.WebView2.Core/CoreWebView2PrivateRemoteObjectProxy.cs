...
internal class CoreWebView2PrivateRemoteObjectProxy
{
    ...
    internal event EventHandler<object> Passivated
    {
        add
        {
            ...
            passivated = (EventHandler<object>)Delegate.Combine(passivated, value);
        }
        remove
        {
            passivated = (EventHandler<object>)Delegate.Remove(passivated, value);
            if (passivated != null)
            {
                return;
            }
